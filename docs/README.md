> **Code-Tomoshibi** 的源码。使用本仓库中 Tomoshibi 的改动必须保留 Tomoshibi 标识，见 [TOMOSHIBI-NOTICE.md](../TOMOSHIBI-NOTICE.md)。
> Using the Tomoshibi changes in this repository requires keeping the Tomoshibi attribution, see [TOMOSHIBI-NOTICE.md](../TOMOSHIBI-NOTICE.md).
