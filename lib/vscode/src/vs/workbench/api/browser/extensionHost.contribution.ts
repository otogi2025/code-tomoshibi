...
// ⛔ 这 4 行别再删：mainThreadExtensionService.ts:58 把全部 MainContext 喂给
//    extensionHostManager.ts:314 的 assertRegistered，@extHostNamedCustomer 只在文件被
//    副作用 import 时才执行；少一行 → 扩展宿主启动即抛 Missing proxy instance（已踩过，站打不开）
