...
export class CommentThreadBody<T extends IRange = IRange> extends Disposable {
	...
	private _updateAriaLabel() {
		if (this._commentThread.range) {
			this._commentsElement.ariaLabel = nls.localize('commentThreadAria.withRange', "通过 {2} 评论行 {1} 上具有 {0} 评论的线程。{3}。",
			...
			this._commentsElement.ariaLabel = nls.localize('commentThreadAria.document', "在整个文档上有 {0} 条注释的注释线程。 {1}。",
