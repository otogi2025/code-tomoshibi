...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: nls.localize('comments.NextCommentedRange', "转至下一个评论范围"),
				original: 'Go to Next Commented Range'
			},
			category: {
				value: nls.localize('commentsCategory', "注释"),
				original: 'Comments'
			},
			menu: [{
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: nls.localize('comments.previousCommentedRange', "转至上一个评论范围"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: nls.localize('comments.nextCommentingRange', "转至下一个评论范围"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: nls.localize('comments.previousCommentingRange', "转至上一个评论范围"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: nls.localize('comments.toggleCommenting', "切换编辑器评论"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: nls.localize('comments.addCommand', "添加对当前所选内容的评论"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: nls.localize('comments.focusCommentOnCurrentLine', "在当前行上聚焦注释"),
	...
	override async run(accessor: ServicesAccessor, ...args: unknown[]): Promise<void> {
		...
		if (error) {
			notificationService.error(nls.localize('comments.focusCommand.error', "光标必须位于带有注释的行上才能聚焦注释"));
		}
	}
});
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: nls.localize('comments.collapseAll', "折叠所有评论"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: nls.localize('comments.expandAll', "展开所有评论"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: nls.localize('comments.expandUnresolved', "展开未解决注释"),
