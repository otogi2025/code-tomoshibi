...
class InspectEditorTokens extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('inspectEditorTokens', "开发人员: 检查编辑器标记和作用域"),
...
class InspectEditorTokensWidget extends Disposable implements IContentWidget {
	...
	private _beginCompute(position: Position): void {
		...
		this._domNode.appendChild(document.createTextNode(nls.localize('inspectTMScopesWidget.loading', "正在加载...")));
