...
export class ToggleOvertypeInsertMode extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				...localize2('toggleOvertypeInsertMode', "切换改写/插入模式"),
				mnemonicTitle: localize({ key: 'mitoggleOvertypeInsertMode', comment: ['&& denotes a mnemonic'] }, "切换(&&T)改写/插入模式"),
			},
			metadata: {
				description: localize2('toggleOvertypeMode.description', "切换改写/插入模式"),
			},
			keybinding: {
