...
export class ToggleMultiCursorModifierAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('toggleLocation', '切换多行修改键'),
			f1: true
		});
	}
...
MenuRegistry.appendMenuItem(MenuId.MenubarSelectionMenu, {
	...
	command: {
		id: ToggleMultiCursorModifierAction.ID,
		title: localize('miMultiCursorAlt', "切换为“Alt+单击”进行多光标功能")
	},
...
MenuRegistry.appendMenuItem(MenuId.MenubarSelectionMenu, {
	...
	command: {
		...
		title: (
			isMacintosh
				? localize('miMultiCursorCmd', "切换为“Cmd+单击”进行多光标功能")
				: localize('miMultiCursorCtrl', "切换为“Ctrl+单击”进行多光标功能")
		)
	},
