...
export const SAVE_FILE_AS_LABEL = nls.localize2('saveAs', "另存为…");
export const SAVE_FILE_COMMAND_ID = 'workbench.action.files.save';
export const SAVE_FILE_LABEL = nls.localize2('save', "保存");
export const SAVE_FILE_WITHOUT_FORMATTING_COMMAND_ID = 'workbench.action.files.saveWithoutFormatting';
export const SAVE_FILE_WITHOUT_FORMATTING_LABEL = nls.localize2('saveWithoutFormatting', "保存但不格式化");
...
export const REMOVE_ROOT_FOLDER_LABEL = nls.localize('removeFolderFromWorkspace', "将文件夹从工作区删除");
...
export const NEW_UNTITLED_FILE_LABEL = nls.localize2('newUntitledFile', "新的无标题文本文件");
