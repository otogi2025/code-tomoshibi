...
export const revealInSideBarCommand = {
	...
	title: nls.localize('revealInSideBar', "在资源管理器视图中显示")
};
...
appendSaveConflictEditorTitleAction('workbench.files.action.acceptLocalChanges', nls.localize('acceptLocalChanges', "使用所做的更改并覆盖文件内容"), Codicon.check, -10, acceptLocalChangesCommand);
appendSaveConflictEditorTitleAction('workbench.files.action.revertLocalChanges', nls.localize('revertLocalChanges', "放弃所做的更改并恢复到文件内容"), Codicon.discard, -9, revertLocalChangesCommand);
...
appendToCommandPalette({
	...
	title: nls.localize2('saveAllInGroup', "全部保存在组中"),
	category: Categories.File
}, IsSessionsWindowContext.negate());
...
appendToCommandPalette({
	...
	title: nls.localize2('compareActiveWithSaved', "比较活动与已保存的文件"),
	category: Categories.File,
	metadata: {
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
	...
	command: {
		...
		title: nls.localize('reopenWith', "重新打开编辑器的方式...")
	},
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
	...
	command: {
		id: COMPARE_WITH_SAVED_COMMAND_ID,
		title: nls.localize('compareWithSaved', "与已保存文件比较"),
		precondition: OpenEditorsDirtyEditorContext
	},
...
const compareResourceCommand = {
	...
	title: nls.localize('compareWithSelected', "与已选项目进行比较")
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
	group: '3_compare',
	order: 20,
...
const compareSelectedCommand = {
	...
	title: nls.localize('compareSelected', "将已选项进行比较")
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
	group: '3_compare',
	order: 30,
