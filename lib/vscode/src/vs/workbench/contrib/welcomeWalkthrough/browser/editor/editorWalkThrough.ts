...
const inputOptions: WalkThroughInputOptions = {
	typeId,
	name: localize('editorWalkThrough.title', "编辑器操场"),
...
export class EditorWalkThroughAction extends Action2 {
	...
	public static readonly LABEL = localize2('editorWalkThrough', '交互式编辑器操场');
	...
	constructor() {
		super({
			...
			f1: true,
			metadata: {
				description: localize2('editorWalkThroughMetadata', "打开交互式操场以了解编辑器。")
			}
		});
	}
