...
export class GoToNextChangeAction extends Action2 {
	constructor() {
		super({
			...
			title: localize2('goToNextChange', '转到下一个更改'),
...
export class GoToPreviousChangeAction extends Action2 {
	constructor() {
		super({
			...
			title: localize2('goToPreviousChange', '转到上一个更改'),
...
export class CollapseAllAction extends Action2 {
	constructor() {
		super({
			...
			title: localize2('collapseAllDiffs', '折叠所有差异'),
...
export class ExpandAllAction extends Action2 {
	constructor() {
		super({
			...
			title: localize2('ExpandAllDiffs', '展开所有差异'),
