...
class AccessibleViewNextCodeBlockAction extends Action2 {
	constructor() {
		super({
			...
			title: localize('editor.action.accessibleViewNextCodeBlock', "可访问视图: 下一个代码块")
		});
	}
	run(accessor: ServicesAccessor): void {
...
class AccessibleViewPreviousCodeBlockAction extends Action2 {
	constructor() {
		super({
			...
			title: localize('editor.action.accessibleViewPreviousCodeBlock', "可访问视图: 上一个代码块")
		});
	}
	run(accessor: ServicesAccessor): void {
...
class AccessibleViewGoToSymbolAction extends Action2 {
	constructor() {
		super({
			...
			title: localize('editor.action.accessibleViewGoToSymbol', "转动辅助视图中的符号")
		});
	}
	run(accessor: ServicesAccessor): void {
...
class AccessibilityHelpConfigureKeybindingsAction extends Action2 {
	constructor() {
		super({
			...
			title: localize('editor.action.accessibilityHelpConfigureUnassignedKeybindings', "未分配辅助功能帮助配置的键绑定")
		});
	}
...
class AccessibilityHelpConfigureAssignedKeybindingsAction extends Action2 {
	constructor() {
		super({
			...
			title: localize('editor.action.accessibilityHelpConfigureAssignedKeybindings', "已分配辅助功能帮助配置的键绑定")
		});
	}
	async run(accessor: ServicesAccessor): Promise<void> {
...
class AccessibleViewAcceptInlineCompletionAction extends Action2 {
	constructor() {
		super({
			...
			title: localize('editor.action.accessibleViewAcceptInlineCompletionAction', "接受内联完成")
		});
	}
	async run(accessor: ServicesAccessor): Promise<void> {
