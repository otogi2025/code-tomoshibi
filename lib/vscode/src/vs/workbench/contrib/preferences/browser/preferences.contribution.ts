...
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(
	EditorPaneDescriptor.create(
		...
		nls.localize('preferencesEditor', "偏好设置编辑器")
	),
	[
		...
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
					...
					title: nls.localize({ key: 'miOpenOnlineSettings', comment: ['&& denotes a mnemonic'] }, "联机服务设置(&&O)"),
					menu: {
						id: MenuId.MenubarPreferencesMenu,
						group: '3_settings',
						order: 1,
		...
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
					...
					category,
					f1: true,
					title: nls.localize2('settings.focusSearch', "聚焦到设置搜索")
				});
			}
		...
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
					...
					title: nls.localize('settings.focusFile', "聚焦到设置文件")
				});
			}
		...
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
					...
					title: nls.localize('settings.showPreviousSearch', "在设置中显示上一个搜索")
				});
			}
		...
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
					...
					title: nls.localize('settings.focusSettingsFromSearchOnEnter', "在搜索中聚焦第一项设置")
				});
			}
		...
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
					...
					title: nls.localize('settings.focusSearchFromSettings', "在设置中聚焦设置搜索")
				});
			}
		...
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
					...
					category,
					title: nls.localize2('settings.focusSettingsTOC', "聚焦到设置目录")
				});
			}
		...
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
					...
					title: nls.localize('settings.focusSettingControl', "焦点设置控制")
				});
			}
		...
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
					...
					f1: true,
					category,
					title: nls.localize2('settings.focusLevelUp', "将焦点上移一级")
				});
			}
		...
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
					...
					title: nls.localize2('openDefaultKeybindingsFile', "打开默认键盘快捷键(JSON)"),
					category,
		...
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
					...
					title: nls.localize2('showUserKeybindings', "显示用户按键绑定"),
					menu: [
						{
							id: MenuId.EditorTitle,
							when: ContextKeyExpr.and(CONTEXT_KEYBINDINGS_EDITOR),
		...
		this._register(registerAction2(class extends Action2 {
			constructor() {
				super({
					...
					title: nls.localize('clearHistory', "清除键盘快捷方式搜索历史记录"),
					category,
					menu: [
						{
							id: MenuId.CommandPalette,
