...
export class SettingsEditor2 extends EditorPane {
	...
	private createHeader(parent: HTMLElement): void {
		...
		const filterAction = this._register(new Action(SETTINGS_EDITOR_COMMAND_SUGGEST_FILTERS,
			localize('filterInput', "筛选器设置"), ThemeIcon.asClassName(preferencesFilterIcon)
		));
	...
	private createBody(parent: HTMLElement): void {
		...
		const clearFilterLink = DOM.append(this.clearFilterLinkContainer, $('a.pointer.prominent', { tabindex: 0 }, localize('clearSearchFilters', '清除筛选')));
