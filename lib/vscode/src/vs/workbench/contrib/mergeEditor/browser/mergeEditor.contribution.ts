	...
	properties: {
		'mergeEditor.diffAlgorithm': {
			...
			markdownEnumDescriptions: [
				localize('diffAlgorithm.legacy', "使用旧差异算法。"),
				localize('diffAlgorithm.advanced', "使用高级差异算法。"),
				localize('diffAlgorithm.advancedExternal', "使用外部 `@vscode/diff` 包提供的高级差异算法(纯 JavaScript)。"),
				localize('diffAlgorithm.advancedWasm', "使用外部 `@vscode/diff` 包提供的高级差异算法(WebAssembly)。"),
			]
		},
