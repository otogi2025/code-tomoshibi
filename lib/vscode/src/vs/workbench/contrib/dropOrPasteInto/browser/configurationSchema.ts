...
const dropAsPreferenceSchema: IConfigurationPropertySchema = {
	...
	description: nls.localize('dropPreferredDescription', "配置删除内容时要使用的首选编辑类型。\r\n\r\n这是编辑种类的已排序列表。将使用首选种类的第一个可用编辑。"),
	default: [],
	items: {
		description: nls.localize('dropKind', "删除编辑的种类标识符。"),
		anyOf: [
			{ type: 'string' },
			{ enum: dropEnumValues }
		],
...
const pasteAsPreferenceSchema: IConfigurationPropertySchema = {
	type: 'array',
	scope: ConfigurationScope.LANGUAGE_OVERRIDABLE,
	description: nls.localize('pastePreferredDescription', "配置粘贴内容时要使用的首选编辑类型。\r\n\r\n这是编辑种类的已排序列表。将使用首选种类的第一个可用编辑。"),
	default: [],
	items: {
		description: nls.localize('pasteKind', "粘贴编辑的种类标识符。"),
		anyOf: [
			{ type: 'string' },
