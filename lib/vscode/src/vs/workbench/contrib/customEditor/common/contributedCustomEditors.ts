		...
		for (const extension of extensions) {
			...
			for (const webviewEditorContribution of extension.value) {
				...
				this.add(new CustomEditorInfo({
					...
					providerDisplayName: extension.description.isBuiltin ? nls.localize('builtinProviderDisplayName', "内置") : extension.description.displayName || extension.description.identifier.value,
