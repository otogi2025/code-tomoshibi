...
export const CustomExecutionSupportedContext = new RawContextKey<boolean>('customExecutionSupported', false, nls.localize('tasks.customExecutionSupported', "是否支持 CustomExecution 任务。请考虑在 \"taskDefinition\" 贡献的 when 子句中使用。"));
export const ShellExecutionSupportedContext = new RawContextKey<boolean>('shellExecutionSupported', false, nls.localize('tasks.shellExecutionSupported', "是否支持 ShellExecution 任务。请考虑在 \"taskDefinition\" 贡献的 when 子句中使用。"));
export const TaskCommandsRegistered = new RawContextKey<boolean>('taskCommandsRegistered', false, nls.localize('tasks.taskCommandsRegistered', "是否已注册任务命令"));
export const ProcessExecutionSupportedContext = new RawContextKey<boolean>('processExecutionSupported', false, nls.localize('tasks.processExecutionSupported', "是否支持 ProcessExecution 任务。请考虑在 \"taskDefinition\" 贡献的 when 子句中使用。"));
export const ServerlessWebContext = new RawContextKey<boolean>('serverlessWebContext', false, nls.localize('tasks.serverlessWebContext', "在没有远程机构的 Web 中时为 True。"));
export const TasksAvailableContext = new RawContextKey<boolean>('tasksAvailable', false, nls.localize('tasks.tasksAvailable', "工作区中是否有任何可用的任务。"));
