...
const dotnetBuild: ITaskEntry = {
	...
	sort: 'NET Core',
	autoDetect: false,
	description: nls.localize('dotnetCore', '执行 .NET Core 生成命令'),
	content: [
		'{',
...
const msbuild: ITaskEntry = {
	...
	label: 'MSBuild',
	autoDetect: false,
	description: nls.localize('msbuild', '执行生成目标'),
	content: [
		'{',
		'\t// See https://go.microsoft.com/fwlink/?LinkId=733558',
		'\t// for the documentation about the tasks.json format',
...
const command: ITaskEntry = {
	...
	label: 'Others',
	autoDetect: false,
	description: nls.localize('externalCommand', '运行任意外部命令的示例'),
	content: [
		'{',
		'\t// See https://go.microsoft.com/fwlink/?LinkId=733558',
		'\t// for the documentation about the tasks.json format',
...
const maven: ITaskEntry = {
	...
	sort: 'MVN',
	autoDetect: false,
	description: nls.localize('Maven', '执行常见的 maven 命令'),
	content: [
		'{',
		'\t// See https://go.microsoft.com/fwlink/?LinkId=733558',
		'\t// for the documentation about the tasks.json format',
