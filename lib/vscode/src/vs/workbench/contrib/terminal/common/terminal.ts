...
export const terminalContributionsDescriptor: IExtensionPointDescriptor<ITerminalContributions> = {
	...
	jsonSchema: {
		description: nls.localize('vscode.extension.contributes.terminal', '参与终端功能。'),
		type: 'object',
		properties: {
			profiles: {
				type: 'array',
				description: nls.localize('vscode.extension.contributes.terminal.profiles', "定义用户可创建的其他终端配置文件。"),
				items: {
					type: 'object',
					required: ['id', 'title'],
					defaultSnippets: [{
					...
					properties: {
						id: {
							description: nls.localize('vscode.extension.contributes.terminal.profiles.id', "终端配置文件提供程序的 ID。"),
							type: 'string',
						},
						title: {
							description: nls.localize('vscode.extension.contributes.terminal.profiles.title', "此终端配置文件的标题。"),
							type: 'string',
						},
						icon: {
							description: nls.localize('vscode.extension.contributes.terminal.types.icon', "要与此终端类型关联的 codicon、URI 或浅色和深色 URI。"),
							anyOf: [{
								type: 'string',
							},
							{
								...
								properties: {
									light: {
										description: nls.localize('vscode.extension.contributes.terminal.types.icon.light', '使用浅色主题时的图标路径'),
										type: 'string'
									},
									dark: {
										description: nls.localize('vscode.extension.contributes.terminal.types.icon.dark', '使用深色主题时的图标路径'),
										type: 'string'
									}
								}
							}]
						...
						titleTemplate: {
							description: nls.localize('vscode.extension.contributes.terminal.profiles.titleTemplate', "终端选项卡的标题模板字符串。支持 ${sequence}、${process}、${cwd} 等变量。覆盖使用此配置文件创建的终端的默认 terminal.integrated.tabs.title 设置。"),
							type: 'string',
						},
					},
				},
			...
			completionProviders: {
				type: 'array',
				description: nls.localize('vscode.extension.contributes.terminal.completionProviders', "定义扩展激活时将注册的终端补全提供程序。"),
				items: {
					type: 'object',
					required: ['id'],
					defaultSnippets: [{
					...
					properties: {
						description: {
							description: nls.localize('vscode.extension.contributes.terminal.completionProviders.description', "对补全提供程序的作用的描述。该描述会显示在“设置”UI 中。"),
							type: 'string',
						},
					},
				},
