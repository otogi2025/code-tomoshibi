...
import '../terminalContrib/tomoshibiActivity/browser/terminal.tomoshibiActivity.contribution.js';
import '../terminalContrib/tomoshibiTouchSelect/browser/terminal.tomoshibiTouchSelect.contribution.js';
