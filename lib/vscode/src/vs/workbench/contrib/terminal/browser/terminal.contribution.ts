...
import { TomoshibiTerminalStatusContribution } from './tomoshibiTerminalStatus.js';
...
import { ITomoshibiSessionService, TomoshibiSessionService } from './tomoshibiSessionService.js';
...
registerSingleton(ITomoshibiSessionService, TomoshibiSessionService, InstantiationType.Delayed);
...
registerWorkbenchContribution2(TomoshibiTerminalStatusContribution.ID, TomoshibiTerminalStatusContribution, WorkbenchPhase.AfterRestored);
