...
registerActiveXtermAction({
	...
	title: localize2('workbench.action.terminal.focusFind', '聚焦查找'),
	keybinding: {
...
registerActiveXtermAction({
	...
	title: localize2('workbench.action.terminal.hideFind', '隐藏查找'),
	keybinding: {
...
registerActiveXtermAction({
	...
	title: localize2('workbench.action.terminal.toggleFindRegex', '切换使用正则表达式进行查找'),
	keybinding: {
...
registerActiveXtermAction({
	...
	title: localize2('workbench.action.terminal.toggleFindWholeWord', '切换使用全字匹配进行查找'),
	keybinding: {
...
registerActiveXtermAction({
	...
	title: localize2('workbench.action.terminal.toggleFindCaseSensitive', '切换使用区分大小写进行查找'),
	keybinding: {
...
registerActiveXtermAction({
	...
	title: localize2('workbench.action.terminal.findNext', '查找下一个'),
	keybinding: [
		{
			primary: KeyCode.F3,
...
registerActiveXtermAction({
	...
	title: localize2('workbench.action.terminal.findPrevious', '查找上一个'),
	keybinding: [
		{
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.searchWorkspace', '搜索工作区'),
	keybinding: [
		{
