...
registerTerminalAction({
	...
	title: localize2('workbench.action.terminal.changeSelectionMode.never', '选择模式: 无'),
	tooltip: localize2('workbench.action.terminal.changeSelectionMode.never.tooltip', '在按下向下键之前不选择最佳建议，按 Tab 或 Enter 时才接受建议。激活以进行更改。'),
	f1: false,
...
registerTerminalAction({
	...
	title: localize2('workbench.action.terminal.changeSelectionMode.partial', '选择模式: 部分(Tab)'),
	tooltip: localize2('workbench.action.terminal.changeSelectionMode.partial.tooltip', '部分选择最佳建议，建议可见时按 Tab 接受建议。激活以进行更改。'),
	f1: false,
	precondition: ContextKeyExpr.and(
		ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated),
		TerminalContextKeys.focus,
...
registerTerminalAction({
	...
	title: localize2('workbench.action.terminal.changeSelectionMode.always', '选择模式: 始终(Tab 或 Enter)'),
	tooltip: localize2('workbench.action.terminal.changeSelectionMode.always.tooltip', '始终选择最佳建议，建议可见时按 Tab 或 Enter 接受建议。激活以进行更改。'),
	f1: false,
...
registerTerminalAction({
	...
	title: localize2('workbench.action.terminal.doNotShowSuggestOnType', '除非明确触发，否则不显示 IntelliSense。这会禁用快速建议以及触发字符设置的相关建议。'),
	f1: false,
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.focus, TerminalContextKeys.isOpen, TerminalContextKeys.suggestWidgetVisible),
	icon: Codicon.eye,
	menu: {
...
registerTerminalAction({
	...
	title: localize2('workbench.action.terminal.showSuggestOnType', '键入时显示 IntelliSense。这会启用命令和参数的快速建议，以及触发字符设置的相关建议。'),
	f1: false,
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.focus, TerminalContextKeys.isOpen, TerminalContextKeys.suggestWidgetVisible),
...
registerTerminalAction({
	...
	title: localize2('workbench.action.terminal.learnMore', '了解详细信息'),
	f1: false,
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.focus, TerminalContextKeys.isOpen, TerminalContextKeys.suggestWidgetVisible),
...
registerTerminalAction({
	...
	title: localize2('workbench.action.terminal.configureSuggestSettings', '配置'),
	f1: false,
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.focus, TerminalContextKeys.isOpen, TerminalContextKeys.suggestWidgetVisible),
	icon: Codicon.gear,
	menu: {
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.triggerSuggest', '触发建议'),
	f1: false,
	keybinding: {
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.resetSuggestWidgetSize', '重置建议小组件大小'),
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.selectPrevSuggestion', '选择上一条建议'),
	f1: false,
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.focus, TerminalContextKeys.isOpen, TerminalContextKeys.suggestWidgetVisible),
	keybinding: {
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.selectPrevPageSuggestion', '选择上一页建议'),
	f1: false,
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.focus, TerminalContextKeys.isOpen, TerminalContextKeys.suggestWidgetVisible),
	keybinding: {
		// Up is bound to other workbench keybindings that this needs to beat
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.selectNextSuggestion', '选择下一条建议'),
	f1: false,
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.focus, TerminalContextKeys.isOpen, TerminalContextKeys.suggestWidgetVisible),
	keybinding: {
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.suggestToggleExplainMode', '建议切换解释模式'),
	f1: false,
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.focus, TerminalContextKeys.isOpen, TerminalContextKeys.suggestWidgetVisible),
	keybinding: {
		// Down is bound to other workbench keybindings that this needs to beat
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.suggestToggleDetailsFocus', '建议切换建议焦点'),
	f1: false,
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.suggestToggleDetails', '建议切换详细信息'),
	f1: false,
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.selectNextPageSuggestion', '选择下一页建议'),
	f1: false,
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.focus, TerminalContextKeys.isOpen, TerminalContextKeys.suggestWidgetVisible),
	keybinding: {
		// Down is bound to other workbench keybindings that this needs to beat
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.acceptSelectedSuggestion', '插入'),
	f1: false,
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.focus, TerminalContextKeys.isOpen, TerminalContextKeys.suggestWidgetVisible),
	keybinding: [{
		primary: KeyCode.Tab,
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.acceptSelectedSuggestionEnter', '接受所选建议 (Enter)'),
	f1: false,
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.focus, TerminalContextKeys.isOpen, TerminalContextKeys.suggestWidgetVisible),
	keybinding: {
		primary: KeyCode.Enter,
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.hideSuggestWidget', '隐藏建议小组件'),
	f1: false,
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.focus, TerminalContextKeys.isOpen, TerminalContextKeys.suggestWidgetVisible),
	keybinding: {
...
registerActiveInstanceAction({
	...
	title: localize2('workbench.action.terminal.hideSuggestWidgetAndNavigateHistory', '隐藏建议小组件并导航历史记录'),
	f1: false,
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), TerminalContextKeys.focus, TerminalContextKeys.isOpen, TerminalContextKeys.suggestWidgetVisible),
	keybinding:
	{
