...
export class SuggestAddon extends Disposable implements ITerminalAddon, ISuggestController {
	...
	private _kindToKindLabelMap = new Map<number, string>([
		[TerminalCompletionItemKind.File, localize('file', '文件')],
		[TerminalCompletionItemKind.Folder, localize('folder', '文件夹')],
		[TerminalCompletionItemKind.SymbolicLinkFile, localize('symbolicLinkFile', '符号链接文件')],
		[TerminalCompletionItemKind.SymbolicLinkFolder, localize('symbolicLinkFolder', '符号链接文件夹')],
		[TerminalCompletionItemKind.Method, localize('method', '方法')],
		[TerminalCompletionItemKind.Alias, localize('alias', '别名')],
		[TerminalCompletionItemKind.Argument, localize('argument', '参数')],
		[TerminalCompletionItemKind.Option, localize('option', '选项')],
		[TerminalCompletionItemKind.OptionValue, localize('optionValue', '选项值')],
		[TerminalCompletionItemKind.Flag, localize('flag', '标志')],
		[TerminalCompletionItemKind.Commit, localize('commit', '提交')],
		[TerminalCompletionItemKind.Branch, localize('branch', '分支')],
		[TerminalCompletionItemKind.Tag, localize('tag', '标记')],
		[TerminalCompletionItemKind.Stash, localize('stash', '储藏')],
		[TerminalCompletionItemKind.Remote, localize('remote', '远程')],
		[TerminalCompletionItemKind.PullRequest, localize('pullRequest', '拉取请求')],
		[TerminalCompletionItemKind.PullRequestDone, localize('pullRequestDone', '拉取请求(完成)')],
		[TerminalCompletionItemKind.InlineSuggestion, localize('inlineSuggestion', '内联建议')],
		[TerminalCompletionItemKind.InlineSuggestionAlwaysOnTop, localize('inlineSuggestionAlwaysOnTop', '内联建议')],
	]);
