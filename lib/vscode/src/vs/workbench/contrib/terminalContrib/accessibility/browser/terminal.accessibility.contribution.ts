...
class FocusAccessibleBufferAction extends Action2 {
	constructor() {
		super({
			...
			title: localize2('workbench.action.terminal.focusAccessibleBuffer', "焦点可访问终端视图"),
...
registerTerminalAction({
	...
	title: localize2('workbench.action.terminal.accessibleBufferGoToNextCommand', "可访问的缓冲区转到下一命令"),
...
registerTerminalAction({
	...
	title: localize2('workbench.action.terminal.accessibleBufferGoToPreviousCommand', "可访问的缓冲区转到上一命令"),
...
registerTerminalAction({
	...
	title: localize2('workbench.action.terminal.scrollToBottomAccessibleView', '滚动到底部的可访问视图'),
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), ContextKeyExpr.and(accessibleViewIsShown, ContextKeyExpr.equals(accessibleViewCurrentProviderId.key, AccessibleViewProviderId.Terminal))),
	keybinding: {
...
registerTerminalAction({
	...
	title: localize2('workbench.action.terminal.scrollToTopAccessibleView', '滚动到顶部的可访问视图'),
	precondition: ContextKeyExpr.and(ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.terminalHasBeenCreated), ContextKeyExpr.and(accessibleViewIsShown, ContextKeyExpr.equals(accessibleViewCurrentProviderId.key, AccessibleViewProviderId.Terminal))),
	keybinding: {
