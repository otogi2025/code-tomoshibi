...
const BUILT_IN_SOURCE = localize('builtin', "内置");
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			category: localize2('developer', "开发人员"),
			title: localize2('resetWelcomePageWalkthroughProgress', "重置欢迎页面演练进度"),
			f1: true,
			metadata: {
				description: localize2('resetGettingStartedProgressDescription', '重置欢迎页面上所有演练步骤的进度，以将其外观设置为初次查看，从而为入门体验提供全新开端。'),
			}
		});
	}
