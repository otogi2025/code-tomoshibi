...
registerAction2(class CopyMatchCommandAction extends Action2 {
	...
	constructor(
		...
		super({
			...
			title: nls.localize2('copyMatchLabel', "复制"),
			category,
			keybinding: {
...
registerAction2(class CopyPathCommandAction extends Action2 {
	...
	constructor(
		...
		super({
			...
			title: nls.localize2('copyPathLabel', "复制路径"),
			category,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
registerAction2(class CopyAllCommandAction extends Action2 {
	...
	constructor(
		...
		super({
			...
			title: nls.localize2('copyAllLabel', "全部复制"),
			category,
			menu: [{
				id: MenuId.SearchContext,
...
registerAction2(class GetSearchResultsAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('getSearchResultsLabel', "获取搜索结果"),
			category,
			f1: false
		});
	}
