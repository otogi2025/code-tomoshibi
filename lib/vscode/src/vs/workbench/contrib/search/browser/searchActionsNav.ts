...
registerAction2(class ToggleWholeWordCommandAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('ToggleWholeWordCommandId.label', "切换整个字词"),
			keybinding: Object.assign({
				weight: KeybindingWeight.WorkbenchContrib,
...
registerAction2(class OpenMatchToSideAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('OpenMatchToSide.label', "打开“匹配到一侧”"),
			category,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
				when: ContextKeyExpr.and(Constants.SearchContext.SearchViewVisibleKey, Constants.SearchContext.FileMatchOrMatchFocusKey),
...
registerAction2(class AddCursorsAtSearchResultsAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('AddCursorsAtSearchResults.label', "在搜索结果中添加游标"),
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
				when: ContextKeyExpr.and(Constants.SearchContext.SearchViewVisibleKey, Constants.SearchContext.FileMatchOrMatchFocusKey),
...
registerAction2(class FocusNextInputAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('FocusNextInputAction.label', "聚焦下一个输入"),
			category,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
registerAction2(class FocusPreviousInputAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('FocusPreviousInputAction.label', "聚焦上一个输入"),
			category,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
				when: ContextKeyExpr.or(
...
registerAction2(class FocusSearchFromResultsAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('FocusSearchFromResults.label', "聚焦搜索结果"),
			category,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
registerAction2(class ToggleSearchOnTypeAction extends Action2 {
	...
	constructor(
		...
		super({
			...
			title: nls.localize2('toggleTabs', "切换类型搜索"),
			category,
		});
...
registerAction2(class FocusSearchListCommandAction extends Action2 {
	...
	constructor(
		...
		super({
			...
			title: nls.localize2('focusSearchListCommandLabel', "聚焦到列表"),
			category,
			f1: true
		});
	}
...
registerAction2(class FocusNextSearchResultAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('FocusNextSearchResult.label', "聚焦下一搜索结果"),
			keybinding: [{
				primary: KeyCode.F4,
				weight: KeybindingWeight.WorkbenchContrib,
			}],
...
registerAction2(class FocusPreviousSearchResultAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('FocusPreviousSearchResult.label', "聚焦到上一搜索结果"),
			keybinding: [{
