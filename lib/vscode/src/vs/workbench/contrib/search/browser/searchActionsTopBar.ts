...
registerAction2(class ClearSearchHistoryCommandAction extends Action2 {
	...
	constructor(
		...
		super({
			...
			title: nls.localize2('clearSearchHistoryLabel', "清除搜索历史记录"),
			category,
			f1: true
		});
...
registerAction2(class CancelSearchAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('CancelSearchAction.label', "取消搜索"),
			icon: searchStopIcon,
			category,
			f1: true,
...
registerAction2(class RefreshAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('RefreshAction.label', "刷新"),
...
registerAction2(class CollapseDeepestExpandedLevelAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('CollapseDeepestExpandedLevelAction.label', "全部折叠"),
			category,
...
registerAction2(class ExpandAllAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('ExpandAllAction.label', "全部展开"),
			category,
...
registerAction2(class ClearSearchResultsAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('ClearSearchResultsAction.label', "清除搜索结果"),
			category,
...
registerAction2(class ViewAsTreeAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('ViewAsTreeAction.label', "以树形式查看"),
			category,
...
registerAction2(class ViewAsListAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('ViewAsListAction.label', "以列表形式查看"),
			category,
...
registerAction2(class SearchWithAIAction extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('SearchWithAIAction.label', "使用 AI 搜索"),
			category,
			f1: true,
