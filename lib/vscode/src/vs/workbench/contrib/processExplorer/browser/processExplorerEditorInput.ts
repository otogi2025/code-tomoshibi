...
const processExplorerEditorIcon = registerIcon('process-explorer-editor-label-icon', Codicon.serverProcess, localize('processExplorerEditorLabelIcon', '进程资源管理器编辑器标签的图标。'));
...
export class ProcessExplorerEditorInput extends EditorInput {
	...
	override getName(): string {
		return localize('processExplorerInputName', "进程资源管理器");
	}
