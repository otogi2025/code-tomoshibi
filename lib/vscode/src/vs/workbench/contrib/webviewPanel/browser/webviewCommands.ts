...
export class ShowWebViewEditorFindWidgetAction extends Action2 {
	...
	public static readonly LABEL = nls.localize('editor.action.webvieweditor.showFind', "显示查找");
...
export class HideWebViewEditorFindCommand extends Action2 {
	...
	public static readonly LABEL = nls.localize('editor.action.webvieweditor.hideFind', "停止查找");
...
export class WebViewEditorFindNextCommand extends Action2 {
	...
	public static readonly LABEL = nls.localize('editor.action.webvieweditor.findNext', '查找下一个');
...
export class WebViewEditorFindPreviousCommand extends Action2 {
	...
	public static readonly LABEL = nls.localize('editor.action.webvieweditor.findPrevious', '查找上一个');
...
export class ReloadWebviewAction extends Action2 {
	...
	static readonly LABEL = nls.localize2('refreshWebviewLabel', "重新加载 Web 视图");
