...
class OpenTipsAndTricksUrlAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				...localize2('openTipsAndTricksUrl', "提示与技巧"),
				mnemonicTitle: localize({ key: 'miTipsAndTricks', comment: ['&& denotes a mnemonic'] }, "贴士和技巧(&&C)"),
			},
			category: Categories.Help,
			f1: true,
			menu: {
...
class OpenNewsletterSignupUrlAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('newsletterSignup', '订阅 VS Code 新闻邮件'),
			category: Categories.Help,
			f1: true
		});
	}
...
class OpenYouTubeUrlAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				...localize2('openYouTubeUrl', "在 YouTube 上加入我们"),
				mnemonicTitle: localize({ key: 'miYouTube', comment: ['&& denotes a mnemonic'] }, "在 YouTube 上加入我们(&&J)"),
			},
			category: Categories.Help,
			f1: true,
			menu: {
	...
	constructor() {
		super({
			...
			title: {
				...
				mnemonicTitle: localize({ key: 'miLicense', comment: ['&& denotes a mnemonic'] }, "查看许可证(&&V)"),
			},
			category: Categories.Help,
			f1: true,
			menu: {
...
class GetStartedWithAccessibilityFeatures extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('getStartedWithAccessibilityFeatures', '辅助功能入门'),
			category: Categories.Help,
			f1: true,
