...
registerAction2(class extends BaseNavigationAction {
	...
	constructor() {
		super({
			...
			title: localize2('navigateLeft', '导航到左侧视图'),
...
registerAction2(class extends BaseNavigationAction {
	...
	constructor() {
		super({
			...
			title: localize2('navigateRight', '导航到右侧视图'),
			category: Categories.View,
			f1: true
		}, Direction.Right);
	}
...
registerAction2(class extends BaseNavigationAction {
	...
	constructor() {
		super({
			...
			title: localize2('navigateUp', '导航到上方视图'),
			category: Categories.View,
			f1: true
		}, Direction.Up);
	}
...
registerAction2(class extends BaseNavigationAction {
	...
	constructor() {
		super({
			...
			title: localize2('navigateDown', '导航到下方视图'),
			category: Categories.View,
			f1: true
		}, Direction.Down);
	}
...
registerAction2(class extends BaseFocusAction {
	...
	constructor() {
		super({
			...
			title: localize2('focusNextPart', '专注下一部分'),
			category: Categories.View,
			f1: true,
			keybinding: {
				primary: KeyCode.F6,
...
registerAction2(class extends BaseFocusAction {
	...
	constructor() {
		super({
			...
			title: localize2('focusPreviousPart', '专注上一部分'),
			category: Categories.View,
			f1: true,
			keybinding: {
