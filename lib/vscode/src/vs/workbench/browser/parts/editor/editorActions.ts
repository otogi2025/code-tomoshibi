...
export class SplitEditorOrthogonalAction extends AbstractSplitEditorAction {
	...
	constructor() {
		super({
			...
			title: localize2('splitEditorOrthogonal', '正交拆分编辑器'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class JoinTwoGroupsAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('joinTwoGroups', '将编辑器组与下一个编辑器组合并'),
			f1: true,
			category: Categories.View
		});
	}
...
export class NavigateBetweenGroupsAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('navigateEditorGroups', '在编辑器组间导航'),
			f1: true,
			category: Categories.View
		});
	}
...
export class CloseLeftEditorsInGroupAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('closeEditorsToTheLeft', '关闭组内左侧的编辑器'),
			f1: true,
			category: Categories.View
		});
	}
...
export class CloseAllEditorsAction extends AbstractCloseAllAction {
	...
	static readonly LABEL = localize2('closeAllEditors', '关闭全部编辑器');
...
export class CloseAllEditorGroupsAction extends AbstractCloseAllAction {
	...
	constructor() {
		super({
			...
			title: localize2('closeAllGroups', '关闭全部编辑器组'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class CloseEditorsInOtherGroupsAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('closeEditorsInOtherGroups', '关闭其他组内的编辑器'),
			f1: true,
			category: Categories.View
		});
	}
...
export class CloseEditorInAllGroupsAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('closeEditorInAllGroups', '关闭所有组内的该编辑器'),
			f1: true,
			category: Categories.View
		});
	}
...
export class MoveGroupLeftAction extends AbstractMoveGroupAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveActiveGroupLeft', '向左移动编辑器组'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class MoveGroupRightAction extends AbstractMoveGroupAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveActiveGroupRight', '向右移动编辑器组'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class MoveGroupUpAction extends AbstractMoveGroupAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveActiveGroupUp', '向上移动编辑器组'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class MoveGroupDownAction extends AbstractMoveGroupAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveActiveGroupDown', '向下移动编辑器组'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class DuplicateGroupLeftAction extends AbstractDuplicateGroupAction {
	...
	constructor() {
		super({
			...
			title: localize2('duplicateActiveGroupLeft', '向左复制编辑器组'),
			f1: true,
			category: Categories.View
		}, GroupDirection.LEFT);
	}
...
export class DuplicateGroupRightAction extends AbstractDuplicateGroupAction {
	...
	constructor() {
		super({
			...
			title: localize2('duplicateActiveGroupRight', '向右复制编辑器组'),
			f1: true,
			category: Categories.View
		}, GroupDirection.RIGHT);
	}
...
export class DuplicateGroupUpAction extends AbstractDuplicateGroupAction {
	...
	constructor() {
		super({
			...
			title: localize2('duplicateActiveGroupUp', '向上复制编辑器组'),
			f1: true,
			category: Categories.View
		}, GroupDirection.UP);
	}
...
export class DuplicateGroupDownAction extends AbstractDuplicateGroupAction {
	...
	constructor() {
		super({
			...
			title: localize2('duplicateActiveGroupDown', '向下复制编辑器组'),
			f1: true,
			category: Categories.View
		}, GroupDirection.DOWN);
	}
...
export class MinimizeOtherGroupsAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('minimizeOtherEditorGroups', '展开编辑器组'),
			f1: true,
			category: Categories.View,
...
export class MinimizeOtherGroupsHideSidebarAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('minimizeOtherEditorGroupsHideSidebar', '展开编辑器组并隐藏侧边栏'),
			f1: true,
			category: Categories.View,
...
export class ResetGroupSizesAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('evenEditorGroups', '重置编辑器组大小'),
			f1: true,
			category: Categories.View
		});
	}
...
export class ToggleGroupSizesAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('toggleEditorWidths', '切换编辑器组大小'),
			f1: true,
			category: Categories.View
		});
	}
...
export class MaximizeGroupHideSidebarAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('maximizeEditorHideSidebar', '最大化编辑器组并隐藏侧边栏'),
			f1: true,
			category: Categories.View,
...
export class ToggleMaximizeEditorGroupAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('toggleMaximizeEditorGroup', '切换最大化编辑器组'),
			f1: true,
			category: Categories.View,
			...
			toggled: {
				...
				title: localize('unmaximizeGroup', "还原编辑器组")
			},
		});
	}
...
export class OpenNextEditor extends AbstractNavigateEditorAction {
	...
	constructor() {
		super({
			...
			title: localize2('openNextEditor', '打开下一个编辑器'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class OpenPreviousEditor extends AbstractNavigateEditorAction {
	...
	constructor() {
		super({
			...
			title: localize2('openPreviousEditor', '打开上一个编辑器'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class OpenNextEditorInGroup extends AbstractNavigateEditorAction {
	...
	constructor() {
		super({
			...
			title: localize2('nextEditorInGroup', '打开组内下一个编辑器'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class OpenPreviousEditorInGroup extends AbstractNavigateEditorAction {
	...
	constructor() {
		super({
			...
			title: localize2('openPreviousEditorInGroup', '打开组内上一个编辑器'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class OpenFirstEditorInGroup extends AbstractNavigateEditorAction {
	...
	constructor() {
		super({
			...
			title: localize2('firstEditorInGroup', '打开组内第一个编辑器'),
			f1: true,
			category: Categories.View
		});
	}
...
export class OpenLastEditorInGroup extends AbstractNavigateEditorAction {
	...
	constructor() {
		super({
			...
			title: localize2('lastEditorInGroup', '打开组内最后一个编辑器'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class NavigateForwardAction extends Action2 {
	...
	static readonly LABEL = localize('navigateForward', "前进");

	constructor() {
		super({
			id: NavigateForwardAction.ID,
			title: {
				...localize2('navigateForward', "前进"),
				mnemonicTitle: localize({ key: 'miForward', comment: ['&& denotes a mnemonic'] }, "前进")
			},
			f1: true,
...
export class NavigateBackwardsAction extends Action2 {
	...
	static readonly LABEL = localize('navigateBack', "后退");

	constructor() {
		super({
			id: NavigateBackwardsAction.ID,
			title: {
				...localize2('navigateBack', "后退"),
				mnemonicTitle: localize({ key: 'miBack', comment: ['&& denotes a mnemonic'] }, "后退")
			},
			f1: true,
...
export class NavigatePreviousAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('navigatePrevious', '转到上一处'),
			f1: true
		});
	}
...
export class NavigateForwardInEditsAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('navigateForwardInEdits', '前进到下一处编辑位置'),
			f1: true
		});
	}
...
export class NavigateBackwardsInEditsAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('navigateBackInEdits', '后退到上一处编辑位置'),
			f1: true
		});
	}
...
export class NavigatePreviousInEditsAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('navigatePreviousInEdits', '转到上一处编辑位置'),
			f1: true
		});
	}
...
export class NavigateToLastEditLocationAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('navigateToLastEditLocation', '转到最后一次编辑位置'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class NavigateForwardInNavigationsAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('navigateForwardInNavigations', '前进到下一处导航位置'),
			f1: true
		});
	}
...
export class NavigateBackwardsInNavigationsAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('navigateBackInNavigations', '后退到上一处导航位置'),
			f1: true
		});
	}
...
export class NavigatePreviousInNavigationsAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('navigatePreviousInNavigationLocations', '转到上一处导航位置'),
			f1: true
		});
	}
...
export class NavigateToLastNavigationLocationAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('navigateToLastNavigationLocation', '转到最后一次导航位置'),
			f1: true
		});
	}
...
export class ReopenClosedEditorAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('reopenClosedEditor', '重新打开已关闭的编辑器'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class ClearRecentFilesAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('clearRecentFiles', '清除最近打开的记录…'),
			f1: true,
	...
	override async run(accessor: ServicesAccessor): Promise<void> {
		...
		const { confirmed } = await dialogService.confirm({
			type: 'warning',
			message: localize('confirmClearRecentsMessage', "要清除全部最近打开的文件和工作区吗？"),
			detail: localize('confirmClearDetail', "此操作不可撤销！"),
			primaryButton: localize({ key: 'clearButtonLabel', comment: ['&& denotes a mnemonic'] }, "清除")
		});
...
export class ShowEditorsInActiveGroupByMostRecentlyUsedAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('showEditorsInActiveGroup', '按最近使用顺序显示活动组中的编辑器'),
			f1: true,
			category: Categories.View
		});
	}
...
export class ShowAllEditorsByAppearanceAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('showAllEditors', '按打开顺序显示所有编辑器'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class ShowAllEditorsByMostRecentlyUsedAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('showAllEditorsByMostRecentlyUsed', '按最近使用顺序显示所有编辑器'),
			f1: true,
			category: Categories.View
		});
	}
...
export class QuickAccessPreviousRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
	...
	constructor() {
		super({
			...
			title: localize2('quickOpenPreviousRecentlyUsedEditor', '快速打开上一个最近使用的编辑器'),
			f1: true,
			category: Categories.View
...
export class QuickAccessLeastRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
	...
	constructor() {
		super({
			...
			title: localize2('quickOpenLeastRecentlyUsedEditor', '快速打开最近最少使用的编辑器'),
			f1: true,
			category: Categories.View
		}, AllEditorsByMostRecentlyUsedQuickAccess.PREFIX, undefined);
	}
...
export class QuickAccessPreviousRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
	...
	constructor() {
		super({
			...
			title: localize2('quickOpenPreviousRecentlyUsedEditorInGroup', '快速打开组内上一个最近使用的编辑器'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class QuickAccessLeastRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
	...
	constructor() {
		super({
			...
			title: localize2('quickOpenLeastRecentlyUsedEditorInGroup', '快速打开组内最近最少使用的编辑器'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class QuickAccessPreviousEditorFromHistoryAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('navigateEditorHistoryByInput', '从历史记录快速打开上一个编辑器'),
			f1: true
		});
	}
...
export class OpenNextRecentlyUsedEditorAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('openNextRecentlyUsedEditor', '打开下一个最近使用的编辑器'),
			f1: true,
			category: Categories.View
		});
	}
...
export class OpenPreviousRecentlyUsedEditorAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('openPreviousRecentlyUsedEditor', '打开上一个最近使用的编辑器'),
			f1: true,
			category: Categories.View
		});
	}
...
export class OpenNextRecentlyUsedEditorInGroupAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('openNextRecentlyUsedEditorInGroup', '打开组内下一个最近使用的编辑器'),
			f1: true,
			category: Categories.View
		});
	}
...
export class OpenPreviousRecentlyUsedEditorInGroupAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('openPreviousRecentlyUsedEditorInGroup', '打开组内上一个最近使用的编辑器'),
			f1: true,
			category: Categories.View
		});
	}
...
export class ClearEditorHistoryWithoutConfirmAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('clearEditorHistoryWithoutConfirm', '不经确认清除编辑器历史记录'),
			f1: true,
...
export class ClearEditorHistoryAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('clearEditorHistory', '清除编辑器历史记录'),
			f1: true
		});
	}
	...
	override async run(accessor: ServicesAccessor): Promise<void> {
		...
		const { confirmed } = await dialogService.confirm({
			type: 'warning',
			message: localize('confirmClearEditorHistoryMessage', "要清除最近打开的编辑器历史记录吗？"),
			detail: localize('confirmClearDetail', "此操作不可撤销！"),
			primaryButton: localize({ key: 'clearButtonLabel', comment: ['&& denotes a mnemonic'] }, "清除")
		});
...
export class MoveEditorLeftInGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveEditorLeft', '向左移动编辑器'),
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class MoveEditorRightInGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveEditorRight', '向右移动编辑器'),
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class MoveEditorToStartAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveEditorToStart', '将编辑器移动到开头'),
			f1: true,
			category: Categories.View
...
export class MoveEditorToEndAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveEditorToEnd', '将编辑器移动到末尾'),
			f1: true,
			category: Categories.View
...
export class MoveEditorToPreviousGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveEditorToPreviousGroup', '将编辑器移动到上一个编辑器组'),
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
				primary: KeyMod.CtrlCmd | KeyMod.Alt | KeyCode.LeftArrow,
				mac: {
...
export class MoveEditorToNextGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveEditorToNextGroup', '将编辑器移动到下一个编辑器组'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
				primary: KeyMod.CtrlCmd | KeyMod.Alt | KeyCode.RightArrow,
...
export class MoveEditorToAboveGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveEditorToAboveGroup', '将编辑器移动到上方编辑器组'),
			f1: true,
			category: Categories.View
...
export class MoveEditorToBelowGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveEditorToBelowGroup', '将编辑器移动到下方编辑器组'),
			f1: true,
			category: Categories.View
...
export class MoveEditorToLeftGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveEditorToLeftGroup', '将编辑器移动到左侧编辑器组'),
			f1: true,
			category: Categories.View
...
export class MoveEditorToRightGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveEditorToRightGroup', '将编辑器移动到右侧编辑器组'),
			f1: true,
			category: Categories.View
...
export class MoveEditorToFirstGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveEditorToFirstGroup', '将编辑器移动到第一个编辑器组'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class MoveEditorToLastGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('moveEditorToLastGroup', '将编辑器移动到最后一个编辑器组'),
			f1: true,
			keybinding: {
				weight: KeybindingWeight.WorkbenchContrib,
...
export class SplitEditorToPreviousGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('splitEditorToPreviousGroup', '将编辑器拆分到上一个编辑器组'),
			f1: true,
			category: Categories.View
...
export class SplitEditorToNextGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('splitEditorToNextGroup', '将编辑器拆分到下一个编辑器组'),
			f1: true,
			category: Categories.View
...
export class SplitEditorToAboveGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('splitEditorToAboveGroup', '将编辑器拆分到上方编辑器组'),
			f1: true,
			category: Categories.View
...
export class SplitEditorToBelowGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('splitEditorToBelowGroup', '将编辑器拆分到下方编辑器组'),
			f1: true,
			category: Categories.View
...
export class SplitEditorToLeftGroupAction extends ExecuteCommandAction {
	...
	static readonly LABEL = localize('splitEditorToLeftGroup', "将编辑器拆分到左侧编辑器组");

	constructor() {
		super({
			id: 'workbench.action.splitEditorToLeftGroup',
			title: localize2('splitEditorToLeftGroup', "将编辑器拆分到左侧编辑器组"),
			f1: true,
			category: Categories.View
...
export class SplitEditorToRightGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('splitEditorToRightGroup', '将编辑器拆分到右侧编辑器组'),
			f1: true,
			category: Categories.View
...
export class SplitEditorToFirstGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('splitEditorToFirstGroup', '将编辑器拆分到第一个编辑器组'),
			f1: true,
			category: Categories.View
...
export class SplitEditorToLastGroupAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('splitEditorToLastGroup', '将编辑器拆分到最后一个编辑器组'),
			f1: true,
			category: Categories.View
...
export class EditorLayoutTwoColumnsBottomAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('editorLayoutTwoColumnsBottom', '底部两列编辑器布局'),
			f1: true,
			category: Categories.View
...
export class EditorLayoutTwoRowsRightAction extends ExecuteCommandAction {
	...
	constructor() {
		super({
			...
			title: localize2('editorLayoutTwoRowsRight', '右侧两行编辑器布局'),
			f1: true,
			category: Categories.View
...
export class NewEditorGroupLeftAction extends AbstractCreateEditorGroupAction {
	...
	constructor() {
		super({
			...
			title: localize2('newGroupLeft', '在左侧新建编辑器组'),
			f1: true,
			category: Categories.View
		}, GroupDirection.LEFT);
	}
...
export class NewEditorGroupRightAction extends AbstractCreateEditorGroupAction {
	...
	constructor() {
		super({
			...
			title: localize2('newGroupRight', '在右侧新建编辑器组'),
			f1: true,
			category: Categories.View
		}, GroupDirection.RIGHT);
	}
...
export class NewEditorGroupAboveAction extends AbstractCreateEditorGroupAction {
	...
	constructor() {
		super({
			...
			title: localize2('newGroupAbove', '在上方新建编辑器组'),
			f1: true,
			category: Categories.View
		}, GroupDirection.UP);
	}
...
export class NewEditorGroupBelowAction extends AbstractCreateEditorGroupAction {
	...
	constructor() {
		super({
			...
			title: localize2('newGroupBelow', '在下方新建编辑器组'),
			f1: true,
			category: Categories.View
		}, GroupDirection.DOWN);
	}
...
export class ToggleEditorTypeAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('toggleEditorType', '切换编辑器类型'),
			f1: true,
			category: Categories.View,
...
export class ReOpenInTextEditorAction extends ExecuteCommandAction {
	...
	static readonly TITLE = localize2('reopenTextEditor', '用文本编辑器重新打开');
...
export class MoveEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
	...
	constructor() {
		super(
			...
			{
				...localize2('moveEditorGroupToNewWindow', "将编辑器组移动到新窗口"),
				mnemonicTitle: localize({ key: 'miMoveEditorGroupToNewWindow', comment: ['&& denotes a mnemonic'] }, "将编辑器组移动到新窗口"),
			},
			true
		);
	}
...
export class CopyEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
	...
	constructor() {
		super(
			...
			{
				...localize2('copyEditorGroupToNewWindow', "将编辑器组复制到新窗口"),
				mnemonicTitle: localize({ key: 'miCopyEditorGroupToNewWindow', comment: ['&& denotes a mnemonic'] }, "将编辑器组复制到新窗口"),
			},
			false
		);
	}
...
export class RestoreEditorsToMainWindowAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				...localize2('restoreEditorsToMainWindow', "将编辑器还原到主窗口"),
				mnemonicTitle: localize({ key: 'miRestoreEditorsToMainWindow', comment: ['&& denotes a mnemonic'] }, "将编辑器还原到主窗口"),
			},
			f1: true,
