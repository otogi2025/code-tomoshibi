...
registerAction2(class extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('toggleCompactAuxiliaryWindow', "切换窗口紧密模式"),
...
registerAction2(class extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize('enableCompactAuxiliaryWindow', "启用紧密模式"),
...
registerAction2(class extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize('disableCompactAuxiliaryWindow', "关闭紧密模式"),
