...
function registerEditorMoveCopyCommand(): void {
	...
	KeybindingsRegistry.registerCommandAndKeybindingRule({
		...
		metadata: {
			description: localize('editorCommand.activeEditorMove.description', "按标签或编辑器组移动活动编辑器"),
			args: [
				{
					name: localize('editorCommand.activeEditorMove.arg.name', "活动编辑器移动参数"),
					description: localize('editorCommand.activeEditorMove.arg.description', "参数属性：\n\t* 'to'：提供移动目标的字符串值。\n\t* 'by'：提供移动单位（按标签或按编辑器组）的字符串值。\n\t* 'value'：提供要移动的位置数或绝对位置的数值。"),
	...
	KeybindingsRegistry.registerCommandAndKeybindingRule({
		...
		metadata: {
			description: localize('editorCommand.activeEditorCopy.description', "按编辑器组复制活动编辑器"),
			args: [
				{
					name: localize('editorCommand.activeEditorCopy.arg.name', "活动编辑器复制参数"),
					description: localize('editorCommand.activeEditorCopy.arg.description', "参数属性：\n\t* 'to'：提供复制目标的字符串值。\n\t* 'value'：提供要复制的位置数或绝对位置的数值。"),
					constraint: isSelectedEditorsMoveCopyArg,
					schema: moveCopyJSONSchema
				}
			]
				...
				schema: {
					...
					'properties': {
						'orientation': {
							...
							'enum': [0, 1],
							'enumDescriptions': [
								localize('editorGroupLayout.horizontal', "水平"),
								localize('editorGroupLayout.vertical', "垂直")
							],
						},
						'groups': {
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('splitEditorInGroup', '在组内拆分编辑器'),
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('joinEditorInGroup', '在组内合并编辑器'),
				category: Categories.View,
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('toggleJoinEditorInGroup', '切换组内拆分编辑器'),
				category: Categories.View,
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('toggleSplitEditorInGroupLayout', '切换组内拆分编辑器的布局'),
				category: Categories.View,
				precondition: SideBySideEditorActiveContext,
				f1: true
			});
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('focusLeftSideEditor', '聚焦活动编辑器的第一侧'),
				category: Categories.View,
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('focusRightSideEditor', '聚焦活动编辑器的第二侧'),
				category: Categories.View,
				precondition: ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext),
				f1: true
			});
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('focusOtherSideEditor', '聚焦活动编辑器的另一侧'),
				category: Categories.View,
				precondition: ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext),
				f1: true
			});
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('toggleEditorGroupLock', '切换编辑器组锁定'),
				category: Categories.View,
				f1: true
			});
		}
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('lockEditorGroup', '锁定编辑器组'),
				category: Categories.View,
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('unlockEditorGroup', '取消锁定编辑器组'),
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('moveToMainWindow', '在主窗口中打开模态编辑器'),
				category: Categories.View,
				f1: true,
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('moveModalEditorToWindow', '在新窗口中打开模态编辑器'),
				category: Categories.View,
				f1: true,
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('toggleModalEditorSidebar', '切换模态编辑器侧边栏'),
				category: Categories.View,
				f1: true,
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('toggleModalEditorMaximized', '最大化模态编辑器'),
				category: Categories.View,
				f1: true,
				precondition: EditorPartModalContext,
				...
				toggled: {
					...
					title: localize('restoreModalEditorSize', "还原模态编辑器")
				},
				menu: {
					id: MenuId.ModalEditorTitle,
					group: 'navigation',
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('closeModalEditor', '关闭模态编辑器'),
				category: Categories.View,
				f1: true,
				icon: Codicon.close,
				precondition: EditorPartModalContext,
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('navigateModalEditorPrevious', '转到模态编辑器中的上一项'),
				category: Categories.View,
	...
	registerAction2(class extends Action2 {
		constructor() {
			super({
				...
				title: localize2('navigateModalEditorNext', '转到模态编辑器中的下一项'),
				category: Categories.View,
				precondition: ContextKeyExpr.and(EditorPartModalContext, EditorPartModalNavigationContext),
				keybinding: {
