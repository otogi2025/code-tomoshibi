...
registerAction2(
	class MoveViewUp extends MoveViewPosition {
		constructor() {
			super({
				id: 'views.moveViewUp',
				title: nls.localize('viewMoveUp', "向上移动视图"),
				keybinding: {
	...
	class MoveViewLeft extends MoveViewPosition {
		constructor() {
			super({
				...
				title: nls.localize('viewMoveLeft', "向左移动视图"),
				keybinding: {
	...
	class MoveViewDown extends MoveViewPosition {
		constructor() {
			super({
				...
				title: nls.localize('viewMoveDown', "向下移动视图"),
				keybinding: {
	...
	class MoveViewRight extends MoveViewPosition {
		constructor() {
			super({
				...
				title: nls.localize('viewMoveRight', "向右移动视图"),
				keybinding: {
...
registerAction2(class MoveViews extends Action2 {
	constructor() {
		super({
			id: 'vscode.moveViews',
			title: nls.localize('viewsMove', "移动视图"),
		});
	}
