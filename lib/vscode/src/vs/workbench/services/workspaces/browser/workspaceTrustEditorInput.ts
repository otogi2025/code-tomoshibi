...
const WorkspaceTrustEditorIcon = registerIcon('workspace-trust-editor-label-icon', Codicon.shield, localize('workspaceTrustEditorLabelIcon', '工作区信任编辑器标签的图标。'));
...
export class WorkspaceTrustEditorInput extends EditorInput {
	...
	override getName(): string {
		return localize('workspaceTrustEditorInputName', "工作区信任");
	}
