...
export const defaultUserDataProfileIcon = registerIcon('defaultProfile-icon', Codicon.settings, localize('defaultProfileIcon', '默认配置文件的图标。'));

export const PROFILES_TITLE = localize2('profiles', '个人资料');
export const PROFILES_CATEGORY = { ...PROFILES_TITLE };
export const PROFILE_EXTENSION = 'code-profile';
export const PROFILE_FILTER = [{ name: localize('profile', "配置文件"), extensions: [PROFILE_EXTENSION] }];
