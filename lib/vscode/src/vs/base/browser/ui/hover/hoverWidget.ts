...
export function getHoverAccessibleViewHint(shouldHaveHint?: boolean, keybinding?: string | null): string | undefined {
	return shouldHaveHint && keybinding ? localize('acessibleViewHint', "在辅助视图中用 {0} 检查此项。", keybinding) : shouldHaveHint ? localize('acessibleViewHintNoKbOpen', "通过命令“打开辅助视图”在辅助视图中检查此项，该命令当前无法通过键绑定触发。") : '';
}
