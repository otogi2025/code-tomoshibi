...
import { FileAccess, connectionTokenCookieName, connectionTokenQueryName, Schemas } from '../../base/common/network.js';
...
export const getOriginalUrl = (req: http.IncomingMessage): string => {
	return (req as http.IncomingMessage & { originalUrl?: string }).originalUrl || req.url || '';
};
