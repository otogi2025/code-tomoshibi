...
function getFeedbackToolDisplay(toolName: string, _args: unknown, result?: IServerToolDisplayResult): IServerToolDisplay | undefined {
	switch (toolName) {
		case addCommentToolName:
			return {
				displayName: localize('toolName.addComment', "添加注释"),
		...
		case listCommentsToolName: {
			...
			return {
				displayName: localize('toolName.listComments', "列出注释"),
		...
		case deleteCommentsToolName:
			return {
				displayName: localize('toolName.deleteComments', "删除注释"),
		...
		case resolveCommentsToolName:
			return {
				displayName: localize('toolName.resolveComments', "解决注释"),
		...
		case viewUnreviewedCommentsToolName:
			return {
				displayName: localize('toolName.viewUnreviewedComments', "查看注释"),
