		...
		properties: {
			[AllowedExtensionsConfigKey]: {
				...
				defaultSnippets: [{
					...
					description: localize('extensions.allowed.all', "允许使用所有扩展。"),
				}],
				...
				policy: {
					...
					localization: {
						description: {
							...
							value: localize('extensions.allowed.policy', "指定允许使用的扩展列表。这有助于通过限制使用未经授权的扩展来维护安全且一致的开发环境。详细信息: https://aka.ms/vscode/enterprise/extensions/allowed"),
						}
					}
				},
				...
				patternProperties: {
						...
						anyOf: [
							{
								...
								description: localize('extensions.allow.description', "允许或禁止使用该扩展。"),
								enumDescriptions: [
									localize('extensions.allowed.enable.desc', "允许使用扩展。"),
									localize('extensions.allowed.disable.desc', "不允许使用扩展。"),
									localize('extensions.allowed.disable.stable.desc', "仅允许使用扩展的稳定版本。"),
								],
							},
							{
								type: 'array',
								...
								description: localize('extensions.allow.version.description', "允许或禁止使用扩展的特定版本。若要指定特定于平台的版本，请使用“platform@1.2.3”格式，例如“win32-x64@1.2.3”。支持的平台包括“win32-x64”、“win32-arm64”、“linux-x64”、“linux-arm64”、“linux-armhf”、“alpine-x64”、“alpine-arm64”、“darwin-x64”、“darwin-arm64”"),
							},
						]
					},
					'([a-z0-9A-Z][a-z0-9-A-Z]*)$': {
						type: ['boolean', 'string'],
						enum: [true, false, 'stable'],
						description: localize('extension.publisher.allow.description', "允许或禁止使用来自该发布者的所有扩展。"),
						enumDescriptions: [
							localize('extensions.publisher.allowed.enable.desc', "允许使用来自该发布者的所有扩展。"),
							localize('extensions.publisher.allowed.disable.desc', "不允许使用来自该发布者的所有扩展。"),
							localize('extensions.publisher.allowed.disable.stable.desc', "仅允许使用来自该发布者的扩展的稳定版本。"),
						],
					},
					'\\*': {
						type: 'boolean',
						enum: [true, false],
						description: localize('extensions.allow.all.description', "允许或禁止使用所有扩展。"),
						enumDescriptions: [
							localize('extensions.allow.all.enable', "允许使用所有扩展。"),
							localize('extensions.allow.all.disable', "禁止使用所有扩展。")
						],
					}
				}
			}
