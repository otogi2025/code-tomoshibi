...
export function LogLevelToLocalizedString(logLevel: LogLevel): ILocalizedString {
	switch (logLevel) {
		case LogLevel.Trace: return { original: 'Trace', value: nls.localize('trace', "跟踪") };
		case LogLevel.Debug: return { original: 'Debug', value: nls.localize('debug', "调试") };
		case LogLevel.Info: return { original: 'Info', value: nls.localize('info', "信息") };
		case LogLevel.Warning: return { original: 'Warning', value: nls.localize('warn', "警告") };
		case LogLevel.Error: return { original: 'Error', value: nls.localize('error', "错误") };
		case LogLevel.Off: return { original: 'Off', value: nls.localize('off', "关") };
	}
}
