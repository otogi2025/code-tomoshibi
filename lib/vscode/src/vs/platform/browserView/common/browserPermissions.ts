...
export const PERMISSION_CATEGORY_DESCRIPTORS: Readonly<Record<PermissionCategory, IPermissionCategoryDescriptor>> = {
	[PermissionCategory.Location]: {
		...
		label: localize('browserPermission.location.label', "位置"),
		description: localize('browserPermission.location.description', "访问此设备的地理位置"),
	...
	[PermissionCategory.Camera]: {
		...
		label: localize('browserPermission.camera.label', "摄像头"),
		description: localize('browserPermission.camera.description', "从摄像头捕获视频"),
	...
	[PermissionCategory.Microphone]: {
		...
		label: localize('browserPermission.microphone.label', "麦克风"),
		description: localize('browserPermission.microphone.description', "从麦克风捕获音频"),
		icon: Codicon.mic,
		permissions: ['media'],
		defaultState: 'ask',
	},
	[PermissionCategory.Sensors]: {
		...
		label: localize('browserPermission.sensors.label', "传感器"),
		description: localize('browserPermission.sensors.description', "读取运动和环境传感器"),
		icon: Codicon.pulse,
		permissions: ['sensors'],
		defaultState: 'allow',
	},
	[PermissionCategory.Clipboard]: {
		...
		label: localize('browserPermission.clipboard.label', "剪贴板"),
		description: localize('browserPermission.clipboard.description', "读取和写入系统剪贴板"),
		icon: Codicon.clippy,
	...
	[PermissionCategory.Notifications]: {
		...
		label: localize('browserPermission.notifications.label', "通知"),
		description: localize('browserPermission.notifications.description', "显示桌面通知"),
		icon: Codicon.bell,
	...
	[PermissionCategory.Devices]: {
		...
		label: localize('browserPermission.devices.label', "设备"),
		description: localize('browserPermission.devices.description', "请求访问 USB、串行、HID 和蓝牙设备"),
		icon: Codicon.plug,
