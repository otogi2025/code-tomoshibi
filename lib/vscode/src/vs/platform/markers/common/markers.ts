...
export namespace MarkerSeverity {
	...
	_displayStrings[MarkerSeverity.Error] = localize('sev.error', "错误");
	_displayStrings[MarkerSeverity.Warning] = localize('sev.warning', "警告");
	_displayStrings[MarkerSeverity.Info] = localize('sev.info', "信息");
	...
	_displayStringsPlural[MarkerSeverity.Error] = localize('sev.errors', "错误");
	_displayStringsPlural[MarkerSeverity.Warning] = localize('sev.warnings', "警告");
	_displayStringsPlural[MarkerSeverity.Info] = localize('sev.infos', "信息");
