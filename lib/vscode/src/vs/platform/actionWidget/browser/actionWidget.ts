...
registerColor(
	...
	localize('actionBar.toggledBackground', '操作栏中切换的操作项的背景色。')
);
...
const ActionWidgetContextKeys = {
	Visible: new RawContextKey<boolean>('codeActionMenuVisible', false, localize('codeActionMenuVisible', "操作小组件列表是否可见")),
	FilterFocused: new RawContextKey<boolean>('codeActionMenuFilterFocused', false, localize('codeActionMenuFilterFocused', "是否聚焦操作小组件筛选器输入")),
};
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('hideCodeActionWidget.title', "隐藏操作小组件"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('clearFilterCodeActionWidget.title', "清除操作小组件筛选器"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('selectPrevCodeAction.title', "选择上一个操作"),
			precondition: ActionWidgetContextKeys.Visible,
			keybinding: {
				weight,
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('selectNextCodeAction.title', "选择下一个操作"),
			precondition: ActionWidgetContextKeys.Visible,
			keybinding: {
				weight,
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('collapseSectionCodeAction.title', "折叠分区"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('expandSectionCodeAction.title', "展开分区"),
			precondition: ContextKeyExpr.and(ActionWidgetContextKeys.Visible, ActionWidgetContextKeys.FilterFocused.negate()),
			keybinding: {
				weight,
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('toggleSectionCodeAction.title', "切换部分"),
			precondition: ContextKeyExpr.and(ActionWidgetContextKeys.Visible, ActionWidgetContextKeys.FilterFocused.negate()),
			keybinding: {
				weight,
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('acceptSelected.title', "接受所选操作"),
			precondition: ActionWidgetContextKeys.Visible,
			keybinding: {
				weight,
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('previewSelected.title', "预览所选操作"),
			precondition: ActionWidgetContextKeys.Visible,
			keybinding: {
				weight,
