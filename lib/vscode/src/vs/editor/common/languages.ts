...
export namespace CompletionItemKinds {
	...
	export function toLabel(kind: CompletionItemKind): string {
		switch (kind) {
			case CompletionItemKind.Method: return localize('suggestWidget.kind.method', '方法');
			case CompletionItemKind.Function: return localize('suggestWidget.kind.function', '函数');
			case CompletionItemKind.Constructor: return localize('suggestWidget.kind.constructor', '构造函数');
			case CompletionItemKind.Field: return localize('suggestWidget.kind.field', '字段');
			case CompletionItemKind.Variable: return localize('suggestWidget.kind.variable', '变量');
			case CompletionItemKind.Class: return localize('suggestWidget.kind.class', '类');
			case CompletionItemKind.Struct: return localize('suggestWidget.kind.struct', '结构');
			case CompletionItemKind.Interface: return localize('suggestWidget.kind.interface', '接口');
			case CompletionItemKind.Module: return localize('suggestWidget.kind.module', '模块');
			case CompletionItemKind.Property: return localize('suggestWidget.kind.property', '属性');
			case CompletionItemKind.Event: return localize('suggestWidget.kind.event', '事件');
			case CompletionItemKind.Operator: return localize('suggestWidget.kind.operator', '运算符');
			case CompletionItemKind.Unit: return localize('suggestWidget.kind.unit', '单位');
			case CompletionItemKind.Value: return localize('suggestWidget.kind.value', '值');
			case CompletionItemKind.Constant: return localize('suggestWidget.kind.constant', '常数');
			case CompletionItemKind.Enum: return localize('suggestWidget.kind.enum', '枚举');
			case CompletionItemKind.EnumMember: return localize('suggestWidget.kind.enumMember', '枚举成员');
			case CompletionItemKind.Keyword: return localize('suggestWidget.kind.keyword', '关键字');
			case CompletionItemKind.Text: return localize('suggestWidget.kind.text', '文本');
			case CompletionItemKind.Color: return localize('suggestWidget.kind.color', '颜色');
			case CompletionItemKind.File: return localize('suggestWidget.kind.file', '文件');
			case CompletionItemKind.Reference: return localize('suggestWidget.kind.reference', '参考');
			case CompletionItemKind.Customcolor: return localize('suggestWidget.kind.customcolor', '自定义颜色');
			case CompletionItemKind.Folder: return localize('suggestWidget.kind.folder', '文件夹');
			case CompletionItemKind.TypeParameter: return localize('suggestWidget.kind.typeParameter', '类型参数');
			case CompletionItemKind.User: return localize('suggestWidget.kind.user', '用户');
			case CompletionItemKind.Issue: return localize('suggestWidget.kind.issue', '问题');
			case CompletionItemKind.Tool: return localize('suggestWidget.kind.tool', '工具');
			case CompletionItemKind.Snippet: return localize('suggestWidget.kind.snippet', '片段');
			default: return '';
		}
	}
...
export const symbolKindNames: { [symbol: number]: string } = {
	[SymbolKind.Array]: localize('Array', "数组"),
	[SymbolKind.Boolean]: localize('Boolean', "布尔值"),
	[SymbolKind.Class]: localize('Class', "类"),
	[SymbolKind.Constant]: localize('Constant', "常数"),
	[SymbolKind.Constructor]: localize('Constructor', "构造函数"),
	[SymbolKind.Enum]: localize('Enum', "枚举"),
	[SymbolKind.EnumMember]: localize('EnumMember', "枚举成员"),
	[SymbolKind.Event]: localize('Event', "事件"),
	[SymbolKind.Field]: localize('Field', "字段"),
	[SymbolKind.File]: localize('File', "文件"),
	[SymbolKind.Function]: localize('Function', "函数"),
	[SymbolKind.Interface]: localize('Interface', "接口"),
	[SymbolKind.Key]: localize('Key', "键"),
	[SymbolKind.Method]: localize('Method', "方法"),
	[SymbolKind.Module]: localize('Module', "模块"),
	[SymbolKind.Namespace]: localize('Namespace', "命名空间"),
	[SymbolKind.Null]: localize('Null', "Null"),
	[SymbolKind.Number]: localize('Number', "数字"),
	[SymbolKind.Object]: localize('Object', "对象"),
	[SymbolKind.Operator]: localize('Operator', "运算符"),
	[SymbolKind.Package]: localize('Package', "包"),
	[SymbolKind.Property]: localize('Property', "属性"),
	[SymbolKind.String]: localize('String', "字符串"),
	[SymbolKind.Struct]: localize('Struct', "结构"),
	[SymbolKind.TypeParameter]: localize('TypeParameter', "类型参数"),
	[SymbolKind.Variable]: localize('Variable', "变量"),
};
