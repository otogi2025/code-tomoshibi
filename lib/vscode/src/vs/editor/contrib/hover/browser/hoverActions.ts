...
export class ShowOrFocusHoverAction extends EditorAction {
	...
	constructor() {
		super({
			...
			metadata: {
				description: nls.localize2('showOrFocusHoverDescription', '显示或聚焦编辑器悬停，该悬停将在当前光标位置显示符号的文档、引用和其他内容。'),
				args: [{
					name: 'args',
					schema: {
						type: 'object',
						properties: {
							'focus': {
								...
								enumDescriptions: [
									nls.localize('showOrFocusHover.focus.noAutoFocus', '悬停不会自动获得焦点。'),
									nls.localize('showOrFocusHover.focus.focusIfVisible', '仅当悬停已可见时，才会获得焦点。'),
									nls.localize('showOrFocusHover.focus.autoFocusImmediately', '悬停在出现时会自动获得焦点。'),
								],
...
export class ShowDefinitionPreviewHoverAction extends EditorAction {
	...
	constructor() {
		super({
			...
			precondition: undefined,
			metadata: {
				description: nls.localize2('showDefinitionPreviewHoverDescription', '在编辑器中显示定义预览悬停。'),
			},
		});
	}
...
export class ScrollUpHoverAction extends EditorAction {
	...
	constructor() {
		super({
			...
			metadata: {
				description: nls.localize2('scrollUpHoverDescription', '向上滚动编辑器悬停。')
			},
		});
	}
...
export class ScrollDownHoverAction extends EditorAction {
	...
	constructor() {
		super({
			...
			metadata: {
				description: nls.localize2('scrollDownHoverDescription', '向下滚动编辑器悬停。'),
			},
		});
	}
...
export class ScrollLeftHoverAction extends EditorAction {
	...
	constructor() {
		super({
			...
			metadata: {
				description: nls.localize2('scrollLeftHoverDescription', '向左滚动编辑器悬停。'),
			},
		});
	}
...
export class ScrollRightHoverAction extends EditorAction {
	...
	constructor() {
		super({
			...
			metadata: {
				description: nls.localize2('scrollRightHoverDescription', '向右滚动编辑器悬停。')
			},
		});
	}
...
export class PageUpHoverAction extends EditorAction {
	...
	constructor() {
		super({
			...
			metadata: {
				description: nls.localize2('pageUpHoverDescription', '将编辑器悬停向上翻页。'),
			},
		});
	}
...
export class PageDownHoverAction extends EditorAction {
	...
	constructor() {
		super({
			...
			metadata: {
				description: nls.localize2('pageDownHoverDescription', '将编辑器悬停向下翻页。'),
			},
		});
	}
...
export class GoToTopHoverAction extends EditorAction {
	...
	constructor() {
		super({
			...
			metadata: {
				description: nls.localize2('goToTopHoverDescription', '转到编辑器悬停的顶部。'),
			},
		});
	}
...
export class GoToBottomHoverAction extends EditorAction {
	...
	constructor() {
		super({
			...
			metadata: {
				description: nls.localize2('goToBottomHoverDescription', '转到编辑器悬停的底部。')
			},
		});
	}
