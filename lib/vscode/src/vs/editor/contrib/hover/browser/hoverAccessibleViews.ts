...
namespace HoverAccessibilityHelpNLS {
	export const increaseVerbosity = localize('increaseVerbosity', '- 使用 Increase Hover Verbosity 命令可以提高聚焦悬停部分的详细程度。', `<keybinding:${INCREASE_HOVER_VERBOSITY_ACTION_ID}>`);
	export const decreaseVerbosity = localize('decreaseVerbosity', '- 使用 Decrease Hover Verbosity 命令可以降低聚焦悬停部分的详细程度。', `<keybinding:${DECREASE_HOVER_VERBOSITY_ACTION_ID}>`);
}
