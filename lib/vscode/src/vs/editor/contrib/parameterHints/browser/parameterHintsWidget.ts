...
const parameterHintsNextIcon = registerIcon('parameter-hints-next', Codicon.chevronDown, nls.localize('parameterHintsNextIcon', '“显示下一个参数”提示的图标。'));
const parameterHintsPreviousIcon = registerIcon('parameter-hints-previous', Codicon.chevronUp, nls.localize('parameterHintsPreviousIcon', '“显示上一个参数”提示的图标。'));
	...
	public render(hints: languages.SignatureHelp): void {
		...
		if (activeParameter) {
			...
			if (this.announcedLabel !== labelToAnnounce) {
				aria.alert(nls.localize('hint', "{0}，提示", labelToAnnounce));
...
registerColor('editorHoverWidget.highlightForeground', listHighlightForeground, nls.localize('editorHoverWidgetHighlightForeground', '参数提示中活动项的前景色。'));
