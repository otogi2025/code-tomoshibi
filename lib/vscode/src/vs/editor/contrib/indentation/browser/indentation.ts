...
export class IndentationToSpacesAction extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('indentationToSpaces', "将缩进转换为空格"),
			precondition: EditorContextKeys.writable,
			metadata: {
				description: nls.localize2('indentationToSpacesDescription', "将制表符缩进转换为空格。"),
			}
		});
	}
...
export class IndentationToTabsAction extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('indentationToTabs', "将缩进转换为制表符"),
			precondition: EditorContextKeys.writable,
			metadata: {
				description: nls.localize2('indentationToTabsDescription', "将空格缩进转换为制表符。"),
			}
		});
	}
...
export class ChangeIndentationSizeAction extends EditorAction {
	...
	public run(accessor: ServicesAccessor, editor: ICodeEditor): void {
		...
		const picks = [1, 2, 3, 4, 5, 6, 7, 8].map(n => ({
			...
			description: (
				n === creationOpts.tabSize && n === modelOpts.tabSize
					? nls.localize('configuredTabSize', "已配置制表符大小")
					: n === creationOpts.tabSize
						? nls.localize('defaultTabSize', "默认制表符大小")
						: n === modelOpts.tabSize
							? nls.localize('currentTabSize', "当前制表符大小")
							: undefined
			)
		}));
		...
		setTimeout(() => {
			quickInputService.pick(picks, { placeHolder: nls.localize({ key: 'selectTabWidth', comment: ['Tab corresponds to the tab key'] }, "选择当前文件的制表符大小"), activeItem: picks[autoFocusIndex] }).then(pick => {
				if (pick) {
...
export class IndentUsingTabs extends ChangeIndentationSizeAction {
	...
	constructor() {
		super(false, false, {
			...
			label: nls.localize2('indentUsingTabs', "使用制表符缩进"),
			precondition: undefined,
			metadata: {
				description: nls.localize2('indentUsingTabsDescription', "使用制表符缩进。"),
			}
		});
	}
}
...
export class IndentUsingSpaces extends ChangeIndentationSizeAction {
	...
	constructor() {
		super(true, false, {
			...
			label: nls.localize2('indentUsingSpaces', "使用空格缩进"),
			precondition: undefined,
			metadata: {
				description: nls.localize2('indentUsingSpacesDescription', "使用空格缩进。"),
			}
		});
	}
}
...
export class ChangeTabDisplaySize extends ChangeIndentationSizeAction {
	...
	constructor() {
		super(true, true, {
			...
			label: nls.localize2('changeTabDisplaySize', "更改制表符显示大小"),
			precondition: undefined,
			metadata: {
				description: nls.localize2('changeTabDisplaySizeDescription', "更改制表符的等效空间大小。"),
			}
		});
	}
}
...
export class DetectIndentation extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('detectIndentation', "从内容中检测缩进方式"),
			precondition: undefined,
			metadata: {
				description: nls.localize2('detectIndentationDescription', "检测内容的缩进。"),
			}
		});
	}
...
export class ReindentLinesAction extends EditorAction {
	constructor() {
		super({
			...
			precondition: EditorContextKeys.writable,
			metadata: {
				description: nls.localize2('editor.reindentlinesDescription', "重新设计编辑器的行缩进。"),
			},
...
export class ReindentSelectedLinesAction extends EditorAction {
	constructor() {
		super({
			...
			label: nls.localize2('editor.reindentselectedlines', "重新缩进所选行"),
			precondition: EditorContextKeys.writable,
			metadata: {
				description: nls.localize2('editor.reindentselectedlinesDescription', "重新设计编辑器所选行的缩进。"),
			},
			canTriggerInlineEdits: true,
		});
	}
