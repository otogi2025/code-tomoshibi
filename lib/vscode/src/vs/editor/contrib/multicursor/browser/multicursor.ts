...
function announceCursorChange(previousCursorState: CursorState[], cursorState: CursorState[]): void {
	...
	if (cursorDiff.length >= 1) {
		...
		const msg = cursorDiff.length === 1 ? nls.localize('cursorAdded', "添加的光标: {0}", cursorPositions) : nls.localize('cursorsAdded', "添加的游标: {0}", cursorPositions);
		status(msg);
	}
}
	...
	constructor() {
		super({
			...
			menuOpts: {
				...
				group: '3_multi',
				title: nls.localize({ key: 'miInsertCursorAbove', comment: ['&& denotes a mnemonic'] }, "在上面添加光标(&&A)"),
				order: 2
			}
		});
	}
	...
	constructor() {
		super({
			...
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '3_multi',
				title: nls.localize({ key: 'miInsertCursorBelow', comment: ['&& denotes a mnemonic'] }, "在下面添加光标(&&D)"),
				order: 3
			}
		});
	}
	...
	constructor() {
		super({
			...
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '3_multi',
				title: nls.localize({ key: 'miInsertCursorAtEndOfEachLineSelected', comment: ['&& denotes a mnemonic'] }, "在行尾添加光标(&&U)"),
				order: 4
			}
		});
	}
...
class InsertCursorAtEndOfLineSelected extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('mutlicursor.addCursorsToBottom', "在底部添加光标"),
			precondition: undefined
		});
	}
...
class InsertCursorAtTopOfLineSelected extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('mutlicursor.addCursorsToTop', "在顶部添加光标"),
			precondition: undefined
		});
	}
...
export class AddSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
	constructor() {
		super({
			...
			label: nls.localize2('addSelectionToNextFindMatch', "将选择内容添加到下一个查找匹配项"),
			precondition: undefined,
			kbOpts: {
...
export class AddSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
	constructor() {
		super({
			...
			label: nls.localize2('addSelectionToPreviousFindMatch', "将选择内容添加到上一个查找匹配项"),
			precondition: undefined,
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '3_multi',
				title: nls.localize({ key: 'miAddSelectionToPreviousFindMatch', comment: ['&& denotes a mnemonic'] }, "添加上一个匹配项(&&R)"),
				order: 6
			}
		});
	}
...
export class MoveSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
	constructor() {
		super({
			...
			label: nls.localize2('moveSelectionToNextFindMatch', "将上次选择内容移动到下一个查找匹配项"),
			precondition: undefined,
			kbOpts: {
				kbExpr: EditorContextKeys.focus,
...
export class MoveSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
	constructor() {
		super({
			...
			label: nls.localize2('moveSelectionToPreviousFindMatch', "将上次选择内容移动到上一个查找匹配项"),
			precondition: undefined
		});
	}
	protected _run(multiCursorController: MultiCursorSelectionController, findController: CommonFindController): void {
...
export class SelectHighlightsAction extends MultiCursorSelectionControllerAction {
	constructor() {
		super({
			...
			label: nls.localize2('selectAllOccurrencesOfFindMatch', "选择所有找到的查找匹配项"),
			precondition: undefined,
			kbOpts: {
				kbExpr: EditorContextKeys.focus,
