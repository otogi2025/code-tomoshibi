	...
	constructor() {
		super(false, {
			...
			menuOpts: {
				...
				group: '2_line',
				title: nls.localize({ key: 'miCopyLinesUp', comment: ['&& denotes a mnemonic'] }, "向上复制一行(&&C)"),
				order: 1
			},
	...
	constructor() {
		super(true, {
			...
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '2_line',
				title: nls.localize({ key: 'miCopyLinesDown', comment: ['&& denotes a mnemonic'] }, "向下复制一行(&&P)"),
				order: 2
			},
			canTriggerInlineEdits: true,
		});
...
export class DuplicateSelectionAction extends EditorAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('duplicateSelection', "重复选择"),
			precondition: EditorContextKeys.writable,
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '2_line',
				title: nls.localize({ key: 'miDuplicateSelection', comment: ['&& denotes a mnemonic'] }, "重复选择(&&D)"),
				order: 5
			},
			canTriggerInlineEdits: true,
		});
	...
	constructor() {
		super(false, {
			...
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '2_line',
				title: nls.localize({ key: 'miMoveLinesUp', comment: ['&& denotes a mnemonic'] }, "向上移动一行(&&V)"),
				order: 3
			},
			canTriggerInlineEdits: true,
		});
	...
	constructor() {
		super(true, {
			...
			menuOpts: {
				menuId: MenuId.MenubarSelectionMenu,
				group: '2_line',
				title: nls.localize({ key: 'miMoveLinesDown', comment: ['&& denotes a mnemonic'] }, "向下移动一行(&&L)"),
				order: 4
			},
			canTriggerInlineEdits: true,
		});
...
export class IndentLinesAction extends EditorAction {
	constructor() {
		super({
			...
			label: nls.localize2('lines.indent', "行缩进"),
			precondition: EditorContextKeys.writable,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class OutdentLinesAction extends EditorAction {
	constructor() {
		super({
			...
			label: nls.localize2('lines.outdent', "行减少缩进"),
			precondition: EditorContextKeys.writable,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
export class SnakeCaseAction extends AbstractCaseAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('editor.transformToSnakecase', "转换为下划线小写"),
			precondition: EditorContextKeys.writable,
			canTriggerInlineEdits: true,
		});
	}
...
export class CamelCaseAction extends AbstractCaseAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('editor.transformToCamelcase', "转换为驼峰式大小写"),
			precondition: EditorContextKeys.writable,
			canTriggerInlineEdits: true
		});
	}
...
export class PascalCaseAction extends AbstractCaseAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('editor.transformToPascalcase', "转换为帕斯卡式大小写"),
			precondition: EditorContextKeys.writable,
			canTriggerInlineEdits: true,
		});
	}
...
export class KebabCaseAction extends AbstractCaseAction {
	...
	constructor() {
		super({
			...
			label: nls.localize2('editor.transformToKebabcase', '转换为短横线小写'),
			precondition: EditorContextKeys.writable,
			canTriggerInlineEdits: true,
		});
	}
