	...
	constructor() {
		super(true, false, {
			...
			menuOpts: {
				...
				icon: registerIcon('marker-navigation-next', Codicon.arrowDown, nls.localize('nextMarkerIcon', '“转到下一个”标记的图标。')),
				group: 'navigation',
				order: 1
			}
		});
	...
	constructor() {
		super(false, false, {
			...
			menuOpts: {
				...
				icon: registerIcon('marker-navigation-previous', Codicon.arrowUp, nls.localize('previousMarkerIcon', '“转到上一个”标记的图标。')),
				group: 'navigation',
				order: 2
			}
		});
