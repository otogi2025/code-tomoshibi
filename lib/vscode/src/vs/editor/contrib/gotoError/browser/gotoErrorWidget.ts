	...
	private getAriaLabel(marker: IMarker): string {
		...
		switch (marker.severity) {
			case MarkerSeverity.Error:
				severityLabel = nls.localize('Error', "错误");
				break;
			case MarkerSeverity.Warning:
				severityLabel = nls.localize('Warning', "警告");
				break;
			case MarkerSeverity.Info:
				severityLabel = nls.localize('Info', "信息");
				break;
			case MarkerSeverity.Hint:
				severityLabel = nls.localize('Hint', "提示");
				break;
		}

		let ariaLabel = nls.localize('marker aria', "{2} 出错，{0}: {1}。", severityLabel, marker.message, marker.startLineNumber + ':' + marker.startColumn);
	...
	showAtMarker(marker: IMarker, markerIdx: number, markerCount: number): void {
		...
		if (model) {
			const detail = markerCount > 1
				? nls.localize('problems', "{0} 个问题(共 {1} 个)", markerIdx, markerCount)
				: nls.localize('change', "{0} 个问题(共 {1} 个)", markerIdx, markerCount);
...
const editorMarkerNavigationError = registerColor('editorMarkerNavigationError.background', { dark: errorDefault, light: errorDefault, hcDark: contrastBorder, hcLight: contrastBorder }, nls.localize('editorMarkerNavigationError', '编辑器标记导航小组件错误颜色。'));
const editorMarkerNavigationErrorHeader = registerColor('editorMarkerNavigationError.headerBackground', { dark: transparent(editorMarkerNavigationError, .1), light: transparent(editorMarkerNavigationError, .1), hcDark: null, hcLight: null }, nls.localize('editorMarkerNavigationErrorHeaderBackground', '编辑器标记导航小组件错误标题背景色。'));

const editorMarkerNavigationWarning = registerColor('editorMarkerNavigationWarning.background', { dark: warningDefault, light: warningDefault, hcDark: contrastBorder, hcLight: contrastBorder }, nls.localize('editorMarkerNavigationWarning', '编辑器标记导航小组件警告颜色。'));
const editorMarkerNavigationWarningHeader = registerColor('editorMarkerNavigationWarning.headerBackground', { dark: transparent(editorMarkerNavigationWarning, .1), light: transparent(editorMarkerNavigationWarning, .1), hcDark: '#0C141F', hcLight: transparent(editorMarkerNavigationWarning, .2) }, nls.localize('editorMarkerNavigationWarningBackground', '编辑器标记导航小组件警告标题背景色。'));

const editorMarkerNavigationInfo = registerColor('editorMarkerNavigationInfo.background', { dark: infoDefault, light: infoDefault, hcDark: contrastBorder, hcLight: contrastBorder }, nls.localize('editorMarkerNavigationInfo', '编辑器标记导航小组件信息颜色。'));
const editorMarkerNavigationInfoHeader = registerColor('editorMarkerNavigationInfo.headerBackground', { dark: transparent(editorMarkerNavigationInfo, .1), light: transparent(editorMarkerNavigationInfo, .1), hcDark: null, hcLight: null }, nls.localize('editorMarkerNavigationInfoHeaderBackground', '编辑器标记导航小组件信息标题背景色。'));

const editorMarkerNavigationBackground = registerColor('editorMarkerNavigation.background', editorBackground, nls.localize('editorMarkerNavigationBackground', '编辑器标记导航小组件背景色。'));
