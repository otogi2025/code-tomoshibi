...
const suggestMoreInfoIcon = registerIcon('suggest-more-info', Codicon.chevronRight, nls.localize('suggestMoreInfoIcon', '建议小组件中的详细信息的图标。'));
...
export class ItemRenderer implements IListRenderer<CompletionItem, ISuggestionTemplateData> {
	...
	renderTemplate(container: HTMLElement): ISuggestionTemplateData {
		...
		readMore.title = nls.localize('readMore', "了解详细信息");
