 ...
 */
const editorSuggestWidgetBackground = registerColor('editorSuggestWidget.background', editorWidgetBackground, nls.localize('editorSuggestWidgetBackground', '建议小组件的背景色。'));
registerColor('editorSuggestWidget.border', editorWidgetBorder, nls.localize('editorSuggestWidgetBorder', '建议小组件的边框颜色。'));
export const editorSuggestWidgetForeground = registerColor('editorSuggestWidget.foreground', editorForeground, nls.localize('editorSuggestWidgetForeground', '建议小组件的前景色。'));
...
registerColor('editorSuggestWidget.selectedIconForeground', { dark: quickInputListFocusIconForeground, light: quickInputListFocusIconForeground, hcDark: editorSuggestWidgetBackground, hcLight: editorSuggestWidgetBackground }, nls.localize('editorSuggestWidgetSelectedIconForeground', '建议小组件中所选条目的图标前景色。'));
export const editorSuggestWidgetSelectedBackground = registerColor('editorSuggestWidget.selectedBackground', { dark: quickInputListFocusBackground, light: quickInputListFocusBackground, hcDark: editorSuggestWidgetForeground, hcLight: editorSuggestWidgetForeground }, nls.localize('editorSuggestWidgetSelectedBackground', '建议小组件中所选条目的背景色。'));
...
registerColor('editorSuggestWidget.highlightForeground', listHighlightForeground, nls.localize('editorSuggestWidgetHighlightForeground', '建议小组件中匹配内容的高亮颜色。'));
registerColor('editorSuggestWidget.focusHighlightForeground', { dark: listFocusHighlightForeground, light: listFocusHighlightForeground, hcDark: editorSuggestWidgetSelectedForeground, hcLight: editorSuggestWidgetSelectedForeground }, nls.localize('editorSuggestWidgetFocusHighlightForeground', '当某项获得焦点时，在建议小组件中突出显示的匹配项的颜色。'));
registerColor('editorSuggestWidgetStatus.foreground', transparent(editorSuggestWidgetForeground, .5), nls.localize('editorSuggestWidgetStatusForeground', '建议小组件状态的前景色。'));
...
export class SuggestWidget implements IDisposable {
	...
	private static LOADING_MESSAGE: string = nls.localize('suggestWidget.loading', "正在加载...");
	private static NO_SUGGESTIONS_MESSAGE: string = nls.localize('suggestWidget.noSuggestions', "无建议。");
	...
	constructor(
		...
		this._list = new List('SuggestWidget', this._listElement, {
			...
			accessibilityProvider: {
				...
				getWidgetAriaLabel: () => nls.localize('suggest', "建议"),
				...
				getAriaLabel: (item: CompletionItem) => {
					...
					return nls.localize('ariaCurrenttSuggestionReadDetails', "{0}，文档: {1}", label, docs);
				},
			}
		});
