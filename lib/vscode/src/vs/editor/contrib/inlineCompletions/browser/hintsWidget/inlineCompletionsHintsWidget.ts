...
const inlineSuggestionHintsNextIcon = registerIcon('inline-suggestion-hints-next', Codicon.chevronRight, localize('parameterHintsNextIcon', '“显示下一个参数”提示的图标。'));
const inlineSuggestionHintsPreviousIcon = registerIcon('inline-suggestion-hints-previous', Codicon.chevronLeft, localize('parameterHintsPreviousIcon', '“显示上一个参数”提示的图标。'));
...
export class InlineSuggestionHintsContentWidget extends Disposable implements IContentWidget {
	...
	constructor(
		...
		this.previousAction = this._register(this.createCommandAction(showPreviousInlineSuggestionActionId, localize('previous', '上一步'), ThemeIcon.asClassName(inlineSuggestionHintsPreviousIcon)));
		...
		this.nextAction = this._register(this.createCommandAction(showNextInlineSuggestionActionId, localize('next', '下一步'), ThemeIcon.asClassName(inlineSuggestionHintsNextIcon)));
