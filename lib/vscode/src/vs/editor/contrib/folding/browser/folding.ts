...
class UnfoldAction extends FoldingAction<FoldingArguments> {
	...
	constructor() {
		super({
			id: 'editor.unfold',
			label: nls.localize2('unfoldAction.label', "展开"),
...
class UnFoldRecursivelyAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('unFoldRecursivelyAction.label', "以递归方式展开"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldAction extends FoldingAction<FoldingArguments> {
	...
	constructor() {
		super({
			id: 'editor.fold',
			label: nls.localize2('foldAction.label', "折叠"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class ToggleFoldAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('toggleFoldAction.label', "切换折叠"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldRecursivelyAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('foldRecursivelyAction.label', "以递归方式折叠"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class ToggleFoldRecursivelyAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('toggleFoldRecursivelyAction.label', "以递归方式切换折叠"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldAllExceptAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('foldAllExcept.label', "折叠除选定项以外的所有项"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class UnfoldAllExceptAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('unfoldAllExcept.label', "展开除所选区域之外的所有区域"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldAllAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			id: 'editor.foldAll',
			label: nls.localize2('foldAllAction.label', "全部折叠"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class UnfoldAllAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			id: 'editor.unfoldAll',
			label: nls.localize2('unfoldAllAction.label', "全部展开"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class GotoParentFoldAction extends FoldingAction<void> {
	constructor() {
		super({
			...
			label: nls.localize2('gotoParentFold.label', "跳转到父级折叠"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
				weight: KeybindingWeight.EditorContrib
...
class GotoPreviousFoldAction extends FoldingAction<void> {
	constructor() {
		super({
			...
			label: nls.localize2('gotoPreviousFold.label', "转到上一个折叠范围"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
				weight: KeybindingWeight.EditorContrib
...
class GotoNextFoldAction extends FoldingAction<void> {
	constructor() {
		super({
			...
			label: nls.localize2('gotoNextFold.label', "转到下一个折叠范围"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
				weight: KeybindingWeight.EditorContrib
...
class FoldRangeFromSelectionAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('createManualFoldRange.label', "根据所选内容创建折叠范围"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class RemoveFoldRangeFromSelectionAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('removeManualFoldingRanges.label', "删除手动折叠范围"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
...
class ToggleImportFoldAction extends FoldingAction<void> {
	...
	constructor() {
		super({
			...
			label: nls.localize2('toggleImportFold.label', "切换导入折叠"),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
				weight: KeybindingWeight.EditorContrib
...
for (let i = 1; i <= 7; i++) {
	registerInstantiatedEditorAction(
		new FoldLevelAction({
			...
			label: nls.localize2('foldLevelAction.label', "折叠级别 {0}", i),
			precondition: CONTEXT_FOLDING_ENABLED,
			kbOpts: {
				kbExpr: EditorContextKeys.editorTextFocus,
