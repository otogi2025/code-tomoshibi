...
export const ctxReferenceSearchVisible = new RawContextKey<boolean>('referenceSearchVisible', false, nls.localize('referenceSearchVisible', "引用速览是否可见，例如“速览引用”或“速览定义”"));
...
export abstract class ReferencesController implements IEditorContribution {
	...
	toggleWidget(range: Range, modelPromise: CancelablePromise<ReferencesModel>, peekMode: boolean): void {
		...
		this._widget.setTitle(nls.localize('labelLoading', "正在加载..."));
