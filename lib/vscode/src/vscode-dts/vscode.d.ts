...
declare module 'vscode' {
	...
	export interface DocumentFilter {
		...
		/**
		 * The type of the container document a document belongs to. This editor has no
		 * container document types, so a filter that sets this property never matches.
		 */
	...
	export interface Tab {
		...
		/**
		 * Defines the structure of the tab i.e. text, custom, etc.
