...
const previewStrings = {
	cspAlertMessageText: vscode.l10n.t("已禁用此文档中的部分内容"),

	cspAlertMessageTitle: vscode.l10n.t("已禁用此 Markdown 预览中的可能不安全的内容。更改 Markdown 预览安全设置以允许不安全内容或启用脚本"),

	cspAlertMessageLabel: vscode.l10n.t("已禁用内容安全警告"),
};
...
export class MdDocumentRenderer {
	...
	public renderFileNotFoundDocument(resource: vscode.Uri): string {
		...
		const body = vscode.l10n.t('找不到 {0}', resourcePath);
		return `<!DOCTYPE html>
			<html>
