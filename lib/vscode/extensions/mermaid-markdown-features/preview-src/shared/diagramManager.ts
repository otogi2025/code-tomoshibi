...
export class DiagramElement {
	...
	constructor(
		...
		this.container.setAttribute('aria-label', 'Mermaid 图表');
	...
	private createZoomControls(): void {
		...
		controls.innerHTML = `
			<button class="pan-mode-btn" title="切换平移模式" aria-label="切换平移模式" aria-pressed="false"><span class="codicon codicon-move" aria-hidden="true"></span></button>
			<button class="zoom-out-btn" title="缩小" aria-label="缩小"><span class="codicon codicon-zoom-out" aria-hidden="true"></span></button>
			<button class="zoom-in-btn" title="放大" aria-label="放大"><span class="codicon codicon-zoom-in" aria-hidden="true"></span></button>
			<button class="zoom-reset-btn" title="重置缩放" aria-label="重置缩放"><span class="codicon codicon-screen-normal" aria-hidden="true"></span></button>
		`;
	...
	private createResizeHandle(): HTMLElement {
		...
		resizeHandle.title = '拖动以调整大小';
		resizeHandle.tabIndex = 0;
		resizeHandle.setAttribute('role', 'separator');
		resizeHandle.setAttribute('aria-label', '调整 Mermaid 图表大小');
